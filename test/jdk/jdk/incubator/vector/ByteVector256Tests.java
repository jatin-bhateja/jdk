 ...
 * @run testng/othervm/timeout=300 -ea -esa -Xbatch -XX:-TieredCompilation ByteVector256Tests
 */
...
@Test
public class ByteVector256Tests extends AbstractVectorTest {
    ...
    static void assertIntersectArraysEquals(boolean[] r, byte[] a, byte[] b, int vector_len) {
        int i = 0, j = 0;
        try {
            for (; i < a.length; i += vector_len) {
                for (j = 0; j < vector_len; j++) {
   ...
   public Object[][] byteSaturatingUnaryOpMaskProvider() {
    ...
    static void ADDByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::ADD);
    }
    ...
    static void ADDByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
        ...
        assertArraysEquals(r, a, b, mask, ByteVector256Tests::ADD);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void SUBByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::SUB);
    }
    ...
    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void SUBByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ByteVector256Tests::SUB);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void MULByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::MUL);
    }
    ...
    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void MULByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ByteVector256Tests::MUL);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void DIVByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::DIV);
    }
    ...
    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void DIVByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ByteVector256Tests::DIV);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void FIRST_NONZEROByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::FIRST_NONZERO);
    }

    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void FIRST_NONZEROByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ByteVector256Tests::FIRST_NONZERO);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void ANDByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::AND);
    }
    ...
    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void ANDByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ByteVector256Tests::AND);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void AND_NOTByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::AND_NOT);
    }

    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void AND_NOTByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ByteVector256Tests::AND_NOT);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void ORByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::OR);
    }
    ...
    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void ORByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ByteVector256Tests::OR);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void XORByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::XOR);
    }

    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void XORByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ByteVector256Tests::XOR);
    }

    @Test(dataProvider = "byteBinaryOpProvider")
    static void addByteVector256TestsBroadcastSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, ByteVector256Tests::add);
    }

    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void addByteVector256TestsBroadcastMaskedSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, ByteVector256Tests::add);
    }

    @Test(dataProvider = "byteBinaryOpProvider")
    static void subByteVector256TestsBroadcastSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, ByteVector256Tests::sub);
    }

    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void subByteVector256TestsBroadcastMaskedSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, ByteVector256Tests::sub);
    }

    @Test(dataProvider = "byteBinaryOpProvider")
    static void mulByteVector256TestsBroadcastSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, ByteVector256Tests::mul);
    }

    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void mulByteVector256TestsBroadcastMaskedSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, ByteVector256Tests::mul);
    }

    @Test(dataProvider = "byteBinaryOpProvider")
    static void divByteVector256TestsBroadcastSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, ByteVector256Tests::div);
    }

    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void divByteVector256TestsBroadcastMaskedSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, ByteVector256Tests::div);
    }

    @Test(dataProvider = "byteBinaryOpProvider")
    static void ORByteVector256TestsBroadcastSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, ByteVector256Tests::OR);
    }
    ...
    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void ORByteVector256TestsBroadcastMaskedSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, ByteVector256Tests::OR);
    }

    @Test(dataProvider = "byteBinaryOpProvider")
    static void ANDByteVector256TestsBroadcastSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, ByteVector256Tests::AND);
    }
    ...
    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void ANDByteVector256TestsBroadcastMaskedSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, ByteVector256Tests::AND);
    }

    @Test(dataProvider = "byteBinaryOpProvider")
    static void ORByteVector256TestsBroadcastLongSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastLongArraysEquals(r, a, b, ByteVector256Tests::OR);
    }

    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void ORByteVector256TestsBroadcastMaskedLongSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastLongArraysEquals(r, a, b, mask, ByteVector256Tests::OR);
    }

    @Test(dataProvider = "byteBinaryOpProvider")
    static void ADDByteVector256TestsBroadcastLongSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastLongArraysEquals(r, a, b, ByteVector256Tests::ADD);
    }

    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void ADDByteVector256TestsBroadcastMaskedLongSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastLongArraysEquals(r, a, b, mask, ByteVector256Tests::ADD);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void LSHLByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::LSHL);
    }

    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void LSHLByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ByteVector256Tests::LSHL);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void ASHRByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::ASHR);
    }

    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void ASHRByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ByteVector256Tests::ASHR);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void LSHRByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::LSHR);
    }

    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void LSHRByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ByteVector256Tests::LSHR);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void LSHLByteVector256TestsScalarShift(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, ByteVector256Tests::LSHL_unary);
    }

    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void LSHLByteVector256TestsScalarShiftMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, mask, ByteVector256Tests::LSHL_unary);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void LSHRByteVector256TestsScalarShift(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, ByteVector256Tests::LSHR_unary);
    }

    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void LSHRByteVector256TestsScalarShiftMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, mask, ByteVector256Tests::LSHR_unary);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void ASHRByteVector256TestsScalarShift(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, ByteVector256Tests::ASHR_unary);
    }

    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void ASHRByteVector256TestsScalarShiftMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, mask, ByteVector256Tests::ASHR_unary);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void RORByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::ROR);
    }

    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void RORByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ByteVector256Tests::ROR);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void ROLByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::ROL);
    }

    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void ROLByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ByteVector256Tests::ROL);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void RORByteVector256TestsScalarShift(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, ByteVector256Tests::ROR_unary);
    }

    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void RORByteVector256TestsScalarShiftMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, mask, ByteVector256Tests::ROR_unary);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void ROLByteVector256TestsScalarShift(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, ByteVector256Tests::ROL_unary);
    }

    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void ROLByteVector256TestsScalarShiftMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, mask, ByteVector256Tests::ROL_unary);
    }
    ...
    static void LSHRByteVector256TestsScalarShiftConst(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, ByteVector256Tests::LSHR_binary_const);
    }

    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void LSHRByteVector256TestsScalarShiftMaskedConst(IntFunction<byte[]> fa,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, mask, ByteVector256Tests::LSHR_binary_const);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void LSHLByteVector256TestsScalarShiftConst(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, ByteVector256Tests::LSHL_binary_const);
    }

    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void LSHLByteVector256TestsScalarShiftMaskedConst(IntFunction<byte[]> fa,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, mask, ByteVector256Tests::LSHL_binary_const);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void ASHRByteVector256TestsScalarShiftConst(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, ByteVector256Tests::ASHR_binary_const);
    }

    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void ASHRByteVector256TestsScalarShiftMaskedConst(IntFunction<byte[]> fa,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, mask, ByteVector256Tests::ASHR_binary_const);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void RORByteVector256TestsScalarShiftConst(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, ByteVector256Tests::ROR_binary_const);
    }

    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void RORByteVector256TestsScalarShiftMaskedConst(IntFunction<byte[]> fa,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, mask, ByteVector256Tests::ROR_binary_const);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void ROLByteVector256TestsScalarShiftConst(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, ByteVector256Tests::ROL_binary_const);
    }

    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void ROLByteVector256TestsScalarShiftMaskedConst(IntFunction<byte[]> fa,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, mask, ByteVector256Tests::ROL_binary_const);
    }
    ...
    static void MAXByteVector256TestsMaskedWithMemOp(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        ...
        assertArraysEquals(r, a, (byte)10, mask, ByteVector256Tests::MAX);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void MINByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::MIN);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void MAXByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::MAX);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void UMINByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::UMIN);
    }

    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void UMINByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ByteVector256Tests::UMIN);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void UMAXByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::UMAX);
    }

    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void UMAXByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ByteVector256Tests::UMAX);
    }
    ...
    static void SADDByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::SADD);
    }

    @Test(dataProvider = "byteSaturatingBinaryOpMaskProvider")
    static void SADDByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ByteVector256Tests::SADD);
    }
    ...
    @Test(dataProvider = "byteSaturatingBinaryOpProvider")
    static void SSUBByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::SSUB);
    }

    @Test(dataProvider = "byteSaturatingBinaryOpMaskProvider")
    static void SSUBByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ByteVector256Tests::SSUB);
    }
    ...
    @Test(dataProvider = "byteSaturatingBinaryOpProvider")
    static void SUADDByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::SUADD);
    }

    @Test(dataProvider = "byteSaturatingBinaryOpMaskProvider")
    static void SUADDByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ByteVector256Tests::SUADD);
    }
    ...
    @Test(dataProvider = "byteSaturatingBinaryOpProvider")
    static void SUSUBByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::SUSUB);
    }

    @Test(dataProvider = "byteSaturatingBinaryOpMaskProvider")
    static void SUSUBByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ByteVector256Tests::SUSUB);
    }

    @Test(dataProvider = "byteBinaryOpProvider")
    static void MINByteVector256TestsBroadcastSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, ByteVector256Tests::MIN);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void MAXByteVector256TestsBroadcastSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, ByteVector256Tests::MAX);
    }
    ...
    static void SUADDAssocByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb, IntFunction<byte[]> fc) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        ...
        assertArraysEqualsAssociative(rl, rr, a, b, c, ByteVector256Tests::SUADD);
    }

    @Test(dataProvider = "byteSaturatingBinaryOpAssocMaskProvider")
    static void SUADDAssocByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
        ...
        assertArraysEqualsAssociative(rl, rr, a, b, c, mask, ByteVector256Tests::SUADD);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void ANDReduceByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        byte ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                ByteVector256Tests::ANDReduce, ByteVector256Tests::ANDReduceAll);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void ANDReduceByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                ByteVector256Tests::ANDReduceMasked, ByteVector256Tests::ANDReduceAllMasked);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void ORReduceByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        byte ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                ByteVector256Tests::ORReduce, ByteVector256Tests::ORReduceAll);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void ORReduceByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                ByteVector256Tests::ORReduceMasked, ByteVector256Tests::ORReduceAllMasked);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void XORReduceByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        byte ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                ByteVector256Tests::XORReduce, ByteVector256Tests::XORReduceAll);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void XORReduceByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                ByteVector256Tests::XORReduceMasked, ByteVector256Tests::XORReduceAllMasked);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void ADDReduceByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        byte ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                ByteVector256Tests::ADDReduce, ByteVector256Tests::ADDReduceAll);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void ADDReduceByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                ByteVector256Tests::ADDReduceMasked, ByteVector256Tests::ADDReduceAllMasked);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void MULReduceByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        byte ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                ByteVector256Tests::MULReduce, ByteVector256Tests::MULReduceAll);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void MULReduceByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                ByteVector256Tests::MULReduceMasked, ByteVector256Tests::MULReduceAllMasked);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void MINReduceByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        byte ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                ByteVector256Tests::MINReduce, ByteVector256Tests::MINReduceAll);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void MINReduceByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                ByteVector256Tests::MINReduceMasked, ByteVector256Tests::MINReduceAllMasked);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void MAXReduceByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        byte ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                ByteVector256Tests::MAXReduce, ByteVector256Tests::MAXReduceAll);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void MAXReduceByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                ByteVector256Tests::MAXReduceMasked, ByteVector256Tests::MAXReduceAllMasked);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void UMINReduceByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        byte ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                ByteVector256Tests::UMINReduce, ByteVector256Tests::UMINReduceAll);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void UMINReduceByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                ByteVector256Tests::UMINReduceMasked, ByteVector256Tests::UMINReduceAllMasked);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void UMAXReduceByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        byte ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                ByteVector256Tests::UMAXReduce, ByteVector256Tests::UMAXReduceAll);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void UMAXReduceByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                ByteVector256Tests::UMAXReduceMasked, ByteVector256Tests::UMAXReduceAllMasked);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void FIRST_NONZEROReduceByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        byte ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                ByteVector256Tests::FIRST_NONZEROReduce, ByteVector256Tests::FIRST_NONZEROReduceAll);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void FIRST_NONZEROReduceByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                ByteVector256Tests::FIRST_NONZEROReduceMasked, ByteVector256Tests::FIRST_NONZEROReduceAllMasked);
    }
    ...
    static void anyTrueByteVector256Tests(IntFunction<boolean[]> fm) {
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertReductionBoolArraysEquals(r, mask, ByteVector256Tests::anyTrue);
    }
    ...
    @Test(dataProvider = "boolUnaryOpProvider")
    static void allTrueByteVector256Tests(IntFunction<boolean[]> fm) {
        boolean[] mask = fm.apply(SPECIES.length());
        boolean[] r = fmr.apply(SPECIES.length());
        ...
        assertReductionBoolArraysEquals(r, mask, ByteVector256Tests::allTrue);
    }
    ...
    static void SUADDReduceByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        byte ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                ByteVector256Tests::SUADDReduce, ByteVector256Tests::SUADDReduceAll);
    }
    ...
    static void SUADDReduceByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                ByteVector256Tests::SUADDReduceMasked, ByteVector256Tests::SUADDReduceAllMasked);
    }

    @Test(dataProvider = "byteBinaryOpProvider")
    static void withByteVector256Tests(IntFunction<byte []> fa, IntFunction<byte []> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
    ...
    static void IS_DEFAULTByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
    ...
    static void IS_DEFAULTMaskedByteVector256Tests(IntFunction<byte[]> fa,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    @Test(dataProvider = "byteTestOpProvider")
    static void IS_NEGATIVEByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteTestOpMaskProvider")
    static void IS_NEGATIVEMaskedByteVector256Tests(IntFunction<byte[]> fa,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    static void LTByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
    ...
    static void LTByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                                IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteCompareOpProvider")
    static void GTByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteCompareOpMaskProvider")
    static void GTByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                                IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteCompareOpProvider")
    static void EQByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteCompareOpMaskProvider")
    static void EQByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                                IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteCompareOpProvider")
    static void NEByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteCompareOpMaskProvider")
    static void NEByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                                IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteCompareOpProvider")
    static void LEByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteCompareOpMaskProvider")
    static void LEByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                                IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteCompareOpProvider")
    static void GEByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteCompareOpMaskProvider")
    static void GEByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                                IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteCompareOpProvider")
    static void ULTByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteCompareOpMaskProvider")
    static void ULTByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                                IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteCompareOpProvider")
    static void UGTByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteCompareOpMaskProvider")
    static void UGTByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                                IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteCompareOpProvider")
    static void ULEByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteCompareOpMaskProvider")
    static void ULEByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                                IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteCompareOpProvider")
    static void UGEByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteCompareOpMaskProvider")
    static void UGEByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                                IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteCompareOpProvider")
    static void LTByteVector256TestsBroadcastSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteCompareOpMaskProvider")
    static void LTByteVector256TestsBroadcastMaskedSmokeTest(IntFunction<byte[]> fa,
    ...
    @Test(dataProvider = "byteCompareOpProvider")
    static void LTByteVector256TestsBroadcastLongSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteCompareOpMaskProvider")
    static void LTByteVector256TestsBroadcastLongMaskedSmokeTest(IntFunction<byte[]> fa,
                                IntFunction<byte[]> fb, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteCompareOpProvider")
    static void EQByteVector256TestsBroadcastSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteCompareOpMaskProvider")
    static void EQByteVector256TestsBroadcastMaskedSmokeTest(IntFunction<byte[]> fa,
                                IntFunction<byte[]> fb, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteCompareOpProvider")
    static void EQByteVector256TestsBroadcastLongSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteCompareOpMaskProvider")
    static void EQByteVector256TestsBroadcastLongMaskedSmokeTest(IntFunction<byte[]> fa,
                                IntFunction<byte[]> fb, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void blendByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ByteVector256Tests::blend);
    }

    @Test(dataProvider = "byteUnaryOpShuffleProvider")
    static void RearrangeByteVector256Tests(IntFunction<byte[]> fa,
    ...
    static void RearrangeByteVector256TestsMaskedSmokeTest(IntFunction<byte[]> fa,
                                                          BiFunction<Integer,Integer,int[]> fs,
                                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        int[] order = fs.apply(a.length, SPECIES.length());
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void compressByteVector256Tests(IntFunction<byte[]> fa,
                                                IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void expandByteVector256Tests(IntFunction<byte[]> fa,
                                                IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void intersectByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void getByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void BroadcastByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void ZeroByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = new byte[a.length];
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void sliceUnaryByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = new byte[a.length];
        ...
        assertArraysEquals(r, a, origin, ByteVector256Tests::sliceUnary);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void sliceBinaryByteVector256TestsBinary(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = new byte[a.length];
        int origin = RAND.nextInt(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, ByteVector256Tests::sliceBinary);
    }
    ...
    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void sliceByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
    IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, mask, ByteVector256Tests::slice);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void unsliceUnaryByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = new byte[a.length];
        int origin = RAND.nextInt(SPECIES.length());
        for (int ic = 0; ic < INVOC_COUNT; ic++) {
        ...
        assertArraysEquals(r, a, origin, ByteVector256Tests::unsliceUnary);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void unsliceBinaryByteVector256TestsBinary(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = new byte[a.length];
        int origin = RAND.nextInt(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, part, ByteVector256Tests::unsliceBinary);
    }
    ...
    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void unsliceByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
    IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, part, mask, ByteVector256Tests::unslice);
    }
    ...
    static void BITWISE_BLENDByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb, IntFunction<byte[]> fc) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] c = fc.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, c, ByteVector256Tests::BITWISE_BLEND);
    }

    @Test(dataProvider = "byteTernaryOpProvider")
    static void bitwiseBlendByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb, IntFunction<byte[]> fc) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] c = fc.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, c, ByteVector256Tests::bitwiseBlend);
    }

    @Test(dataProvider = "byteTernaryOpMaskProvider")
    static void BITWISE_BLENDByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<byte[]> fc, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] c = fc.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, c, mask, ByteVector256Tests::BITWISE_BLEND);
    }

    @Test(dataProvider = "byteTernaryOpProvider")
    static void BITWISE_BLENDByteVector256TestsBroadcastSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb, IntFunction<byte[]> fc) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] c = fc.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, c, ByteVector256Tests::BITWISE_BLEND);
    }

    @Test(dataProvider = "byteTernaryOpProvider")
    static void BITWISE_BLENDByteVector256TestsAltBroadcastSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb, IntFunction<byte[]> fc) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] c = fc.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertAltBroadcastArraysEquals(r, a, b, c, ByteVector256Tests::BITWISE_BLEND);
    }

    @Test(dataProvider = "byteTernaryOpProvider")
    static void bitwiseBlendByteVector256TestsBroadcastSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb, IntFunction<byte[]> fc) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] c = fc.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, c, ByteVector256Tests::bitwiseBlend);
    }

    @Test(dataProvider = "byteTernaryOpProvider")
    static void bitwiseBlendByteVector256TestsAltBroadcastSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb, IntFunction<byte[]> fc) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] c = fc.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertAltBroadcastArraysEquals(r, a, b, c, ByteVector256Tests::bitwiseBlend);
    }

    @Test(dataProvider = "byteTernaryOpMaskProvider")
    static void BITWISE_BLENDByteVector256TestsBroadcastMaskedSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<byte[]> fc, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] c = fc.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, c, mask, ByteVector256Tests::BITWISE_BLEND);
    }

    @Test(dataProvider = "byteTernaryOpMaskProvider")
    static void BITWISE_BLENDByteVector256TestsAltBroadcastMaskedSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<byte[]> fc, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] c = fc.apply(SPECIES.length());
        ...
        assertAltBroadcastArraysEquals(r, a, b, c, mask, ByteVector256Tests::BITWISE_BLEND);
    }

    @Test(dataProvider = "byteTernaryOpProvider")
    static void BITWISE_BLENDByteVector256TestsDoubleBroadcastSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb, IntFunction<byte[]> fc) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] c = fc.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertDoubleBroadcastArraysEquals(r, a, b, c, ByteVector256Tests::BITWISE_BLEND);
    }

    @Test(dataProvider = "byteTernaryOpProvider")
    static void bitwiseBlendByteVector256TestsDoubleBroadcastSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb, IntFunction<byte[]> fc) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] c = fc.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertDoubleBroadcastArraysEquals(r, a, b, c, ByteVector256Tests::bitwiseBlend);
    }

    @Test(dataProvider = "byteTernaryOpMaskProvider")
    static void BITWISE_BLENDByteVector256TestsDoubleBroadcastMaskedSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<byte[]> fc, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] c = fc.apply(SPECIES.length());
        ...
        assertDoubleBroadcastArraysEquals(r, a, b, c, mask, ByteVector256Tests::BITWISE_BLEND);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void NEGByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, ByteVector256Tests::NEG);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void NEGMaskedByteVector256Tests(IntFunction<byte[]> fa,
                                                IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, ByteVector256Tests::NEG);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void ABSByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, ByteVector256Tests::ABS);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void ABSMaskedByteVector256Tests(IntFunction<byte[]> fa,
                                                IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, ByteVector256Tests::ABS);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void NOTByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, ByteVector256Tests::NOT);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void NOTMaskedByteVector256Tests(IntFunction<byte[]> fa,
                                                IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, ByteVector256Tests::NOT);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void ZOMOByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, ByteVector256Tests::ZOMO);
    }

    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void ZOMOMaskedByteVector256Tests(IntFunction<byte[]> fa,
                                                IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, ByteVector256Tests::ZOMO);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void BIT_COUNTByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, ByteVector256Tests::BIT_COUNT);
    }

    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void BIT_COUNTMaskedByteVector256Tests(IntFunction<byte[]> fa,
                                                IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, ByteVector256Tests::BIT_COUNT);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void TRAILING_ZEROS_COUNTByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, ByteVector256Tests::TRAILING_ZEROS_COUNT);
    }

    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void TRAILING_ZEROS_COUNTMaskedByteVector256Tests(IntFunction<byte[]> fa,
                                                IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, ByteVector256Tests::TRAILING_ZEROS_COUNT);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void LEADING_ZEROS_COUNTByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, ByteVector256Tests::LEADING_ZEROS_COUNT);
    }

    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void LEADING_ZEROS_COUNTMaskedByteVector256Tests(IntFunction<byte[]> fa,
                                                IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, ByteVector256Tests::LEADING_ZEROS_COUNT);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void REVERSEByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, ByteVector256Tests::REVERSE);
    }

    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void REVERSEMaskedByteVector256Tests(IntFunction<byte[]> fa,
                                                IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, ByteVector256Tests::REVERSE);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void REVERSE_BYTESByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, ByteVector256Tests::REVERSE_BYTES);
    }

    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void REVERSE_BYTESMaskedByteVector256Tests(IntFunction<byte[]> fa,
                                                IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, ByteVector256Tests::REVERSE_BYTES);
    }
    ...
    static void maskandByteVector256Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::band);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskorByteVector256Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::bor);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskxorByteVector256Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::bxor);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskandNotByteVector256Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::bandNot);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskeqByteVector256Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, ByteVector256Tests::beq);
    }
    ...
    static void masknotByteVector256Tests(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, ByteVector256Tests::unot);
    }
    ...
    static void maskFromToLongByteVector256Tests(IntFunction<long[]> fa) {
    ...
    @Test(dataProvider = "byteCompareOpProvider")
    static void eqByteVector256TestsBroadcastMaskedSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void toIntArrayByteVector256TestsSmokeTest(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void toLongArrayByteVector256TestsSmokeTest(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void toDoubleArrayByteVector256TestsSmokeTest(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void toStringByteVector256TestsSmokeTest(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void hashCodeByteVector256TestsSmokeTest(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void reinterpretAsBytesByteVector256TestsSmokeTest(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = new byte[a.length];
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void ADDReduceLongByteVector256Tests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        ...
        assertReductionLongArraysEquals(r, ra, a,
                ByteVector256Tests::ADDReduceLong, ByteVector256Tests::ADDReduceAllLong);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void ADDReduceLongByteVector256TestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        long[] r = lfr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionLongArraysEqualsMasked(r, ra, a, mask,
                ByteVector256Tests::ADDReduceLongMasked, ByteVector256Tests::ADDReduceAllLongMasked);
    }

    @Test(dataProvider = "byteUnaryOpProvider")
    static void BroadcastLongByteVector256TestsSmokeTest(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = new byte[a.length];
    ...
    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void blendByteVector256TestsBroadcastLongSmokeTest(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastLongArraysEquals(r, a, b, mask, ByteVector256Tests::blend);
    }


    @Test(dataProvider = "byteUnaryOpSelectFromProvider")
    static void SelectFromByteVector256Tests(IntFunction<byte[]> fa,
    ...
    static void SelectFromTwoVectorByteVector256Tests(IntFunction<byte[]> fa, IntFunction<byte[]> fb, IntFunction<byte[]> fc) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
    ...
    static void SelectFromByteVector256TestsMaskedSmokeTest(IntFunction<byte[]> fa,
                                                           BiFunction<Integer,Integer,byte[]> fs,
                                                           IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] order = fs.apply(a.length, SPECIES.length());
    ...
    static void shuffleMiscellaneousByteVector256TestsSmokeTest(BiFunction<Integer,Integer,int[]> fs) {
    ...
    @Test(dataProvider = "shuffleProvider")
    static void shuffleToStringByteVector256TestsSmokeTest(BiFunction<Integer,Integer,int[]> fs) {
        int[] a = fs.apply(SPECIES.length() * BUFFER_REPS, SPECIES.length());
    ...
    static void shuffleEqualsByteVector256TestsSmokeTest(BiFunction<Integer,Integer,int[]> fa, BiFunction<Integer,Integer,int[]> fb) {
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskEqualsByteVector256Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
    ...
    static void maskHashCodeByteVector256TestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "maskProvider")
    static void maskTrueCountByteVector256TestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        ...
        assertMaskReductionArraysEquals(r, a, ByteVector256Tests::maskTrueCount);
    }
    ...
    @Test(dataProvider = "maskProvider")
    static void maskLastTrueByteVector256TestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        int[] r = new int[a.length];
        ...
        assertMaskReductionArraysEquals(r, a, ByteVector256Tests::maskLastTrue);
    }
    ...
    @Test(dataProvider = "maskProvider")
    static void maskFirstTrueByteVector256TestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        int[] r = new int[a.length];
        ...
        assertMaskReductionArraysEquals(r, a, ByteVector256Tests::maskFirstTrue);
    }

    @Test(dataProvider = "maskProvider")
    static void maskCompressByteVector256TestsSmokeTest(IntFunction<boolean[]> fa) {
        int trueCount = 0;
        boolean[] a = fa.apply(SPECIES.length());
    ...
    static void indexInRangeByteVector256TestsSmokeTest(int offset) {
    ...
    @Test(dataProvider = "offsetProvider")
    static void indexInRangeLongByteVector256TestsSmokeTest(int offset) {
    ...
    static void loopBoundByteVector256TestsSmokeTest(int length) {
    ...
    @Test(dataProvider = "lengthProvider")
    static void loopBoundLongByteVector256TestsSmokeTest(int _length) {
        long length = _length;
    ...
    @Test
    static void ElementSizeByteVector256TestsSmokeTest() {
    ...
    @Test
    static void VectorShapeByteVector256TestsSmokeTest() {
        ByteVector av = ByteVector.zero(SPECIES);
    ...
    @Test
    static void ShapeWithLanesByteVector256TestsSmokeTest() {
        ByteVector av = ByteVector.zero(SPECIES);
        VectorShape vsh = av.shape();
    ...
    @Test
    static void SpeciesElementSizeByteVector256TestsSmokeTest() {
        ByteVector av = ByteVector.zero(SPECIES);
        assert(av.species().elementSize() == Byte.SIZE);
    }

    @Test
    static void VectorTypeByteVector256TestsSmokeTest() {
        ByteVector av = ByteVector.zero(SPECIES);
        assert(av.species().vectorType() == av.getClass());
    }

    @Test
    static void WithLanesByteVector256TestsSmokeTest() {
        ByteVector av = ByteVector.zero(SPECIES);
    ...
    @Test
    static void WithShapeByteVector256TestsSmokeTest() {
        ByteVector av = ByteVector.zero(SPECIES);
        VectorShape vsh = av.shape();
    ...
    @Test
    static void MaskAllTrueByteVector256TestsSmokeTest() {
        for (int ic = 0; ic < INVOC_COUNT; ic++) {
