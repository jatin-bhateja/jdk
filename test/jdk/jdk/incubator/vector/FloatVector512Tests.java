 ...
 * @run testng/othervm/timeout=300 -ea -esa -Xbatch -XX:-TieredCompilation FloatVector512Tests
 */
...
@Test
public class FloatVector512Tests extends AbstractVectorTest {
...
relativeError));
    ...
    static void assertIntersectArraysEquals(boolean[] r, float[] a, float[] b, int vector_len) {
        int i = 0, j = 0;
        try {
            for (; i < a.length; i += vector_len) {
                for (j = 0; j < vector_len; j++) {
   ...
   static void assertArraysEqualsAssociative(float[] rl, float[] rr, float[] a, float[] b, float[] c, boolean[] mask, FBinOp f) {
    ...
    static void ADDFloatVector512Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        ...
        assertArraysEquals(r, a, b, FloatVector512Tests::ADD);
    }
    ...
    static void ADDFloatVector512TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
        ...
        assertArraysEquals(r, a, b, mask, FloatVector512Tests::ADD);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void SUBFloatVector512Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, FloatVector512Tests::SUB);
    }
    ...
    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void SUBFloatVector512TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, FloatVector512Tests::SUB);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void MULFloatVector512Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, FloatVector512Tests::MUL);
    }
    ...
    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void MULFloatVector512TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, FloatVector512Tests::MUL);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void DIVFloatVector512Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, FloatVector512Tests::DIV);
    }
    ...
    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void DIVFloatVector512TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, FloatVector512Tests::DIV);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void FIRST_NONZEROFloatVector512Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, FloatVector512Tests::FIRST_NONZERO);
    }

    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void FIRST_NONZEROFloatVector512TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, FloatVector512Tests::FIRST_NONZERO);
    }

    @Test(dataProvider = "floatBinaryOpProvider")
    static void addFloatVector512TestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, FloatVector512Tests::add);
    }

    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void addFloatVector512TestsBroadcastMaskedSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, FloatVector512Tests::add);
    }

    @Test(dataProvider = "floatBinaryOpProvider")
    static void subFloatVector512TestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, FloatVector512Tests::sub);
    }

    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void subFloatVector512TestsBroadcastMaskedSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, FloatVector512Tests::sub);
    }

    @Test(dataProvider = "floatBinaryOpProvider")
    static void mulFloatVector512TestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, FloatVector512Tests::mul);
    }

    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void mulFloatVector512TestsBroadcastMaskedSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, FloatVector512Tests::mul);
    }

    @Test(dataProvider = "floatBinaryOpProvider")
    static void divFloatVector512TestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, FloatVector512Tests::div);
    }

    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void divFloatVector512TestsBroadcastMaskedSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, FloatVector512Tests::div);
    }

    @Test(dataProvider = "floatBinaryOpProvider")
    static void ADDFloatVector512TestsBroadcastLongSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastLongArraysEquals(r, a, b, FloatVector512Tests::ADD);
    }

    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void ADDFloatVector512TestsBroadcastMaskedLongSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
    ...
    static void MAXFloatVector512TestsMaskedWithMemOp(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        ...
        assertArraysEquals(r, a, (float)10, mask, FloatVector512Tests::MAX);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void MINFloatVector512Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, FloatVector512Tests::MIN);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void MAXFloatVector512Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, FloatVector512Tests::MAX);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void MINFloatVector512TestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, FloatVector512Tests::MIN);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void MAXFloatVector512TestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, FloatVector512Tests::MAX);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void ADDReduceFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        float ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                FloatVector512Tests::ADDReduce, FloatVector512Tests::ADDReduceAll, RELATIVE_ROUNDING_ERROR_FACTOR_ADD);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void ADDReduceFloatVector512TestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                FloatVector512Tests::ADDReduceMasked, FloatVector512Tests::ADDReduceAllMasked, RELATIVE_ROUNDING_ERROR_FACTOR_ADD);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void MULReduceFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        float ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                FloatVector512Tests::MULReduce, FloatVector512Tests::MULReduceAll, RELATIVE_ROUNDING_ERROR_FACTOR_MUL);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void MULReduceFloatVector512TestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                FloatVector512Tests::MULReduceMasked, FloatVector512Tests::MULReduceAllMasked, RELATIVE_ROUNDING_ERROR_FACTOR_MUL);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void MINReduceFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        float ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                FloatVector512Tests::MINReduce, FloatVector512Tests::MINReduceAll);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void MINReduceFloatVector512TestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                FloatVector512Tests::MINReduceMasked, FloatVector512Tests::MINReduceAllMasked);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void MAXReduceFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        float ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                FloatVector512Tests::MAXReduce, FloatVector512Tests::MAXReduceAll);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void MAXReduceFloatVector512TestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                FloatVector512Tests::MAXReduceMasked, FloatVector512Tests::MAXReduceAllMasked);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void FIRST_NONZEROReduceFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        float ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                FloatVector512Tests::FIRST_NONZEROReduce, FloatVector512Tests::FIRST_NONZEROReduceAll);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void FIRST_NONZEROReduceFloatVector512TestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                FloatVector512Tests::FIRST_NONZEROReduceMasked, FloatVector512Tests::FIRST_NONZEROReduceAllMasked);
    }

    @Test(dataProvider = "floatBinaryOpProvider")
    static void withFloatVector512Tests(IntFunction<float []> fa, IntFunction<float []> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
    ...
    static void IS_DEFAULTFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    static void IS_DEFAULTMaskedFloatVector512Tests(IntFunction<float[]> fa,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    @Test(dataProvider = "floatTestOpProvider")
    static void IS_NEGATIVEFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatTestOpMaskProvider")
    static void IS_NEGATIVEMaskedFloatVector512Tests(IntFunction<float[]> fa,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    @Test(dataProvider = "floatTestOpProvider")
    static void IS_FINITEFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatTestOpMaskProvider")
    static void IS_FINITEMaskedFloatVector512Tests(IntFunction<float[]> fa,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    @Test(dataProvider = "floatTestOpProvider")
    static void IS_NANFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatTestOpMaskProvider")
    static void IS_NANMaskedFloatVector512Tests(IntFunction<float[]> fa,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    @Test(dataProvider = "floatTestOpProvider")
    static void IS_INFINITEFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatTestOpMaskProvider")
    static void IS_INFINITEMaskedFloatVector512Tests(IntFunction<float[]> fa,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    static void LTFloatVector512Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    static void LTFloatVector512TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void GTFloatVector512Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void GTFloatVector512TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void EQFloatVector512Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void EQFloatVector512TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void NEFloatVector512Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void NEFloatVector512TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void LEFloatVector512Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void LEFloatVector512TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void GEFloatVector512Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void GEFloatVector512TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void LTFloatVector512TestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void LTFloatVector512TestsBroadcastMaskedSmokeTest(IntFunction<float[]> fa,
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void LTFloatVector512TestsBroadcastLongSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void LTFloatVector512TestsBroadcastLongMaskedSmokeTest(IntFunction<float[]> fa,
                                IntFunction<float[]> fb, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void EQFloatVector512TestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void EQFloatVector512TestsBroadcastMaskedSmokeTest(IntFunction<float[]> fa,
                                IntFunction<float[]> fb, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void EQFloatVector512TestsBroadcastLongSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void EQFloatVector512TestsBroadcastLongMaskedSmokeTest(IntFunction<float[]> fa,
                                IntFunction<float[]> fb, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void blendFloatVector512Tests(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, FloatVector512Tests::blend);
    }

    @Test(dataProvider = "floatUnaryOpShuffleProvider")
    static void RearrangeFloatVector512Tests(IntFunction<float[]> fa,
    ...
    static void RearrangeFloatVector512TestsMaskedSmokeTest(IntFunction<float[]> fa,
                                                          BiFunction<Integer,Integer,int[]> fs,
                                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        int[] order = fs.apply(a.length, SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void compressFloatVector512Tests(IntFunction<float[]> fa,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void expandFloatVector512Tests(IntFunction<float[]> fa,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void getFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void BroadcastFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void ZeroFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = new float[a.length];
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void sliceUnaryFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = new float[a.length];
        ...
        assertArraysEquals(r, a, origin, FloatVector512Tests::sliceUnary);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void sliceBinaryFloatVector512TestsBinary(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = new float[a.length];
        int origin = RAND.nextInt(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, FloatVector512Tests::sliceBinary);
    }
    ...
    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void sliceFloatVector512TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
    IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, mask, FloatVector512Tests::slice);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void unsliceUnaryFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = new float[a.length];
        int origin = RAND.nextInt(SPECIES.length());
        for (int ic = 0; ic < INVOC_COUNT; ic++) {
        ...
        assertArraysEquals(r, a, origin, FloatVector512Tests::unsliceUnary);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void unsliceBinaryFloatVector512TestsBinary(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = new float[a.length];
        int origin = RAND.nextInt(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, part, FloatVector512Tests::unsliceBinary);
    }
    ...
    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void unsliceFloatVector512TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
    IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, part, mask, FloatVector512Tests::unslice);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void SINFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector512Tests::SIN, FloatVector512Tests::strictSIN);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void EXPFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector512Tests::EXP, FloatVector512Tests::strictEXP);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void LOG1PFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector512Tests::LOG1P, FloatVector512Tests::strictLOG1P);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void LOGFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector512Tests::LOG, FloatVector512Tests::strictLOG);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void LOG10FloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector512Tests::LOG10, FloatVector512Tests::strictLOG10);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void EXPM1FloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector512Tests::EXPM1, FloatVector512Tests::strictEXPM1);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void COSFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector512Tests::COS, FloatVector512Tests::strictCOS);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void TANFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector512Tests::TAN, FloatVector512Tests::strictTAN);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void SINHFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector512Tests::SINH, FloatVector512Tests::strictSINH);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void COSHFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector512Tests::COSH, FloatVector512Tests::strictCOSH);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void TANHFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector512Tests::TANH, FloatVector512Tests::strictTANH);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void ASINFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector512Tests::ASIN, FloatVector512Tests::strictASIN);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void ACOSFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector512Tests::ACOS, FloatVector512Tests::strictACOS);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void ATANFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector512Tests::ATAN, FloatVector512Tests::strictATAN);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void CBRTFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector512Tests::CBRT, FloatVector512Tests::strictCBRT);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void HYPOTFloatVector512Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, b, FloatVector512Tests::HYPOT, FloatVector512Tests::strictHYPOT);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void POWFloatVector512Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, b, FloatVector512Tests::POW, FloatVector512Tests::strictPOW);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void ATAN2FloatVector512Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, b, FloatVector512Tests::ATAN2, FloatVector512Tests::strictATAN2);
    }


    @Test(dataProvider = "floatBinaryOpProvider")
    static void POWFloatVector512TestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEqualsWithinOneUlp(r, a, b, FloatVector512Tests::POW, FloatVector512Tests::strictPOW);
    }
    ...
    static void FMAFloatVector512Tests(IntFunction<float[]> fa, IntFunction<float[]> fb, IntFunction<float[]> fc) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, c, FloatVector512Tests::FMA);
    }
    ...
    static void FMAFloatVector512TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
        ...
        assertArraysEquals(r, a, b, c, mask, FloatVector512Tests::FMA);
    }

    @Test(dataProvider = "floatTernaryOpProvider")
    static void FMAFloatVector512TestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb, IntFunction<float[]> fc) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] c = fc.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, c, FloatVector512Tests::FMA);
    }

    @Test(dataProvider = "floatTernaryOpProvider")
    static void FMAFloatVector512TestsAltBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb, IntFunction<float[]> fc) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] c = fc.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertAltBroadcastArraysEquals(r, a, b, c, FloatVector512Tests::FMA);
    }

    @Test(dataProvider = "floatTernaryOpMaskProvider")
    static void FMAFloatVector512TestsBroadcastMaskedSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<float[]> fc, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] c = fc.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, c, mask, FloatVector512Tests::FMA);
    }

    @Test(dataProvider = "floatTernaryOpMaskProvider")
    static void FMAFloatVector512TestsAltBroadcastMaskedSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<float[]> fc, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] c = fc.apply(SPECIES.length());
        ...
        assertAltBroadcastArraysEquals(r, a, b, c, mask, FloatVector512Tests::FMA);
    }

    @Test(dataProvider = "floatTernaryOpProvider")
    static void FMAFloatVector512TestsDoubleBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb, IntFunction<float[]> fc) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] c = fc.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertDoubleBroadcastArraysEquals(r, a, b, c, FloatVector512Tests::FMA);
    }
    ...
    @Test(dataProvider = "floatTernaryOpMaskProvider")
    static void FMAFloatVector512TestsDoubleBroadcastMaskedSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<float[]> fc, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] c = fc.apply(SPECIES.length());
        ...
        assertDoubleBroadcastArraysEquals(r, a, b, c, mask, FloatVector512Tests::FMA);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void NEGFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, FloatVector512Tests::NEG);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void NEGMaskedFloatVector512Tests(IntFunction<float[]> fa,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, FloatVector512Tests::NEG);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void ABSFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, FloatVector512Tests::ABS);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void ABSMaskedFloatVector512Tests(IntFunction<float[]> fa,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, FloatVector512Tests::ABS);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void SQRTFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, FloatVector512Tests::SQRT);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void SQRTMaskedFloatVector512Tests(IntFunction<float[]> fa,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, FloatVector512Tests::SQRT);
    }
    ...
    static void maskandFloatVector512Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        ...
        assertArraysEquals(r, a, b, FloatVector512Tests::band);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskorFloatVector512Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, FloatVector512Tests::bor);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskxorFloatVector512Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, FloatVector512Tests::bxor);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskandNotFloatVector512Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, FloatVector512Tests::bandNot);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskeqFloatVector512Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, FloatVector512Tests::beq);
    }
    ...
    static void masknotFloatVector512Tests(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, FloatVector512Tests::unot);
    }
    ...
    static void maskFromToLongFloatVector512Tests(IntFunction<long[]> fa) {
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void eqFloatVector512TestsBroadcastMaskedSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    static void toIntArrayFloatVector512TestsSmokeTest(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    static void toLongArrayFloatVector512TestsSmokeTest(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void toDoubleArrayFloatVector512TestsSmokeTest(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void toStringFloatVector512TestsSmokeTest(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void hashCodeFloatVector512TestsSmokeTest(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void ADDReduceLongFloatVector512Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        ...
        assertReductionLongArraysEquals(r, ra, a,
                FloatVector512Tests::ADDReduceLong, FloatVector512Tests::ADDReduceAllLong);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void ADDReduceLongFloatVector512TestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        long[] r = lfr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionLongArraysEqualsMasked(r, ra, a, mask,
                FloatVector512Tests::ADDReduceLongMasked, FloatVector512Tests::ADDReduceAllLongMasked);
    }

    @Test(dataProvider = "floattoLongUnaryOpProvider")
    static void BroadcastLongFloatVector512TestsSmokeTest(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = new float[a.length];
    ...
    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void blendFloatVector512TestsBroadcastLongSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastLongArraysEquals(r, a, b, mask, FloatVector512Tests::blend);
    }


    @Test(dataProvider = "floatUnaryOpSelectFromProvider")
    static void SelectFromFloatVector512Tests(IntFunction<float[]> fa,
    ...
    static void SelectFromTwoVectorFloatVector512Tests(IntFunction<float[]> fa, IntFunction<float[]> fb, IntFunction<float[]> fc) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    static void SelectFromFloatVector512TestsMaskedSmokeTest(IntFunction<float[]> fa,
                                                           BiFunction<Integer,Integer,float[]> fs,
                                                           IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] order = fs.apply(a.length, SPECIES.length());
    ...
    static void shuffleMiscellaneousFloatVector512TestsSmokeTest(BiFunction<Integer,Integer,int[]> fs) {
    ...
    @Test(dataProvider = "shuffleProvider")
    static void shuffleToStringFloatVector512TestsSmokeTest(BiFunction<Integer,Integer,int[]> fs) {
        int[] a = fs.apply(SPECIES.length() * BUFFER_REPS, SPECIES.length());
    ...
    static void shuffleEqualsFloatVector512TestsSmokeTest(BiFunction<Integer,Integer,int[]> fa, BiFunction<Integer,Integer,int[]> fb) {
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskEqualsFloatVector512Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
    ...
    static void maskHashCodeFloatVector512TestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "maskProvider")
    static void maskTrueCountFloatVector512TestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        ...
        assertMaskReductionArraysEquals(r, a, FloatVector512Tests::maskTrueCount);
    }
    ...
    @Test(dataProvider = "maskProvider")
    static void maskLastTrueFloatVector512TestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        int[] r = new int[a.length];
        ...
        assertMaskReductionArraysEquals(r, a, FloatVector512Tests::maskLastTrue);
    }
    ...
    @Test(dataProvider = "maskProvider")
    static void maskFirstTrueFloatVector512TestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        int[] r = new int[a.length];
        ...
        assertMaskReductionArraysEquals(r, a, FloatVector512Tests::maskFirstTrue);
    }

    @Test(dataProvider = "maskProvider")
    static void maskCompressFloatVector512TestsSmokeTest(IntFunction<boolean[]> fa) {
        int trueCount = 0;
        boolean[] a = fa.apply(SPECIES.length());
    ...
    static void indexInRangeFloatVector512TestsSmokeTest(int offset) {
    ...
    @Test(dataProvider = "offsetProvider")
    static void indexInRangeLongFloatVector512TestsSmokeTest(int offset) {
    ...
    static void loopBoundFloatVector512TestsSmokeTest(int length) {
    ...
    @Test(dataProvider = "lengthProvider")
    static void loopBoundLongFloatVector512TestsSmokeTest(int _length) {
        long length = _length;
    ...
    @Test
    static void ElementSizeFloatVector512TestsSmokeTest() {
    ...
    @Test
    static void VectorShapeFloatVector512TestsSmokeTest() {
        FloatVector av = FloatVector.zero(SPECIES);
    ...
    @Test
    static void ShapeWithLanesFloatVector512TestsSmokeTest() {
        FloatVector av = FloatVector.zero(SPECIES);
        VectorShape vsh = av.shape();
    ...
    @Test
    static void ElementTypeFloatVector512TestsSmokeTest() {
        FloatVector av = FloatVector.zero(SPECIES);
        assert(av.species().elementType() == float.class);
    }

    @Test
    static void SpeciesElementSizeFloatVector512TestsSmokeTest() {
        FloatVector av = FloatVector.zero(SPECIES);
        assert(av.species().elementSize() == Float.SIZE);
    }

    @Test
    static void VectorTypeFloatVector512TestsSmokeTest() {
        FloatVector av = FloatVector.zero(SPECIES);
        assert(av.species().vectorType() == av.getClass());
    }

    @Test
    static void WithLanesFloatVector512TestsSmokeTest() {
        FloatVector av = FloatVector.zero(SPECIES);
    ...
    @Test
    static void MaskAllTrueFloatVector512TestsSmokeTest() {
        for (int ic = 0; ic < INVOC_COUNT; ic++) {
