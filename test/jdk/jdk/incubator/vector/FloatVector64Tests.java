 ...
 * @run testng/othervm/timeout=300 -ea -esa -Xbatch -XX:-TieredCompilation FloatVector64Tests
 */
...
@Test
public class FloatVector64Tests extends AbstractVectorTest {
...
relativeError));
   ...
   static void assertArraysEqualsAssociative(float[] rl, float[] rr, float[] a, float[] b, float[] c, boolean[] mask, FBinOp f) {
    ...
    static void ADDFloatVector64Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        ...
        assertArraysEquals(r, a, b, FloatVector64Tests::ADD);
    }
    ...
    static void ADDFloatVector64TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
        ...
        assertArraysEquals(r, a, b, mask, FloatVector64Tests::ADD);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void SUBFloatVector64Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, FloatVector64Tests::SUB);
    }
    ...
    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void SUBFloatVector64TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, FloatVector64Tests::SUB);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void MULFloatVector64Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, FloatVector64Tests::MUL);
    }
    ...
    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void MULFloatVector64TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, FloatVector64Tests::MUL);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void DIVFloatVector64Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, FloatVector64Tests::DIV);
    }
    ...
    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void DIVFloatVector64TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, FloatVector64Tests::DIV);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void FIRST_NONZEROFloatVector64Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, FloatVector64Tests::FIRST_NONZERO);
    }

    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void FIRST_NONZEROFloatVector64TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, FloatVector64Tests::FIRST_NONZERO);
    }

    @Test(dataProvider = "floatBinaryOpProvider")
    static void addFloatVector64TestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, FloatVector64Tests::add);
    }

    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void addFloatVector64TestsBroadcastMaskedSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, FloatVector64Tests::add);
    }

    @Test(dataProvider = "floatBinaryOpProvider")
    static void subFloatVector64TestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, FloatVector64Tests::sub);
    }

    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void subFloatVector64TestsBroadcastMaskedSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, FloatVector64Tests::sub);
    }

    @Test(dataProvider = "floatBinaryOpProvider")
    static void mulFloatVector64TestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, FloatVector64Tests::mul);
    }

    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void mulFloatVector64TestsBroadcastMaskedSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, FloatVector64Tests::mul);
    }

    @Test(dataProvider = "floatBinaryOpProvider")
    static void divFloatVector64TestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, FloatVector64Tests::div);
    }

    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void divFloatVector64TestsBroadcastMaskedSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, FloatVector64Tests::div);
    }

    @Test(dataProvider = "floatBinaryOpProvider")
    static void ADDFloatVector64TestsBroadcastLongSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastLongArraysEquals(r, a, b, FloatVector64Tests::ADD);
    }

    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void ADDFloatVector64TestsBroadcastMaskedLongSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
    ...
    static void MAXFloatVector64TestsMaskedWithMemOp(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        ...
        assertArraysEquals(r, a, (float)10, mask, FloatVector64Tests::MAX);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void MINFloatVector64Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, FloatVector64Tests::MIN);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void MAXFloatVector64Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, FloatVector64Tests::MAX);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void MINFloatVector64TestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, FloatVector64Tests::MIN);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void MAXFloatVector64TestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, FloatVector64Tests::MAX);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void ADDReduceFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        float ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                FloatVector64Tests::ADDReduce, FloatVector64Tests::ADDReduceAll, RELATIVE_ROUNDING_ERROR_FACTOR_ADD);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void ADDReduceFloatVector64TestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                FloatVector64Tests::ADDReduceMasked, FloatVector64Tests::ADDReduceAllMasked, RELATIVE_ROUNDING_ERROR_FACTOR_ADD);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void MULReduceFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        float ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                FloatVector64Tests::MULReduce, FloatVector64Tests::MULReduceAll, RELATIVE_ROUNDING_ERROR_FACTOR_MUL);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void MULReduceFloatVector64TestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void MINReduceFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        float ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                FloatVector64Tests::MINReduce, FloatVector64Tests::MINReduceAll);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void MINReduceFloatVector64TestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                FloatVector64Tests::MINReduceMasked, FloatVector64Tests::MINReduceAllMasked);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void MAXReduceFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        float ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                FloatVector64Tests::MAXReduce, FloatVector64Tests::MAXReduceAll);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void MAXReduceFloatVector64TestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                FloatVector64Tests::MAXReduceMasked, FloatVector64Tests::MAXReduceAllMasked);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void FIRST_NONZEROReduceFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        float ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                FloatVector64Tests::FIRST_NONZEROReduce, FloatVector64Tests::FIRST_NONZEROReduceAll);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void FIRST_NONZEROReduceFloatVector64TestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                FloatVector64Tests::FIRST_NONZEROReduceMasked, FloatVector64Tests::FIRST_NONZEROReduceAllMasked);
    }

    @Test(dataProvider = "floatBinaryOpProvider")
    static void withFloatVector64Tests(IntFunction<float []> fa, IntFunction<float []> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
    ...
    static void IS_DEFAULTFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    static void IS_DEFAULTMaskedFloatVector64Tests(IntFunction<float[]> fa,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    @Test(dataProvider = "floatTestOpProvider")
    static void IS_NEGATIVEFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatTestOpMaskProvider")
    static void IS_NEGATIVEMaskedFloatVector64Tests(IntFunction<float[]> fa,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    @Test(dataProvider = "floatTestOpProvider")
    static void IS_FINITEFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatTestOpMaskProvider")
    static void IS_FINITEMaskedFloatVector64Tests(IntFunction<float[]> fa,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    @Test(dataProvider = "floatTestOpProvider")
    static void IS_NANFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatTestOpMaskProvider")
    static void IS_NANMaskedFloatVector64Tests(IntFunction<float[]> fa,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    @Test(dataProvider = "floatTestOpProvider")
    static void IS_INFINITEFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatTestOpMaskProvider")
    static void IS_INFINITEMaskedFloatVector64Tests(IntFunction<float[]> fa,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    static void LTFloatVector64Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    static void LTFloatVector64TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void GTFloatVector64Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void GTFloatVector64TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void EQFloatVector64Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void EQFloatVector64TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void NEFloatVector64Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void NEFloatVector64TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void LEFloatVector64Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void LEFloatVector64TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void GEFloatVector64Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void GEFloatVector64TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void LTFloatVector64TestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void LTFloatVector64TestsBroadcastMaskedSmokeTest(IntFunction<float[]> fa,
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void LTFloatVector64TestsBroadcastLongSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void LTFloatVector64TestsBroadcastLongMaskedSmokeTest(IntFunction<float[]> fa,
                                IntFunction<float[]> fb, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void EQFloatVector64TestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void EQFloatVector64TestsBroadcastMaskedSmokeTest(IntFunction<float[]> fa,
                                IntFunction<float[]> fb, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void EQFloatVector64TestsBroadcastLongSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void EQFloatVector64TestsBroadcastLongMaskedSmokeTest(IntFunction<float[]> fa,
                                IntFunction<float[]> fb, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void blendFloatVector64Tests(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, FloatVector64Tests::blend);
    }

    @Test(dataProvider = "floatUnaryOpShuffleProvider")
    static void RearrangeFloatVector64Tests(IntFunction<float[]> fa,
    ...
    static void RearrangeFloatVector64TestsMaskedSmokeTest(IntFunction<float[]> fa,
                                                          BiFunction<Integer,Integer,int[]> fs,
                                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        int[] order = fs.apply(a.length, SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void compressFloatVector64Tests(IntFunction<float[]> fa,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void expandFloatVector64Tests(IntFunction<float[]> fa,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void getFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void BroadcastFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void ZeroFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = new float[a.length];
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void sliceUnaryFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = new float[a.length];
        ...
        assertArraysEquals(r, a, origin, FloatVector64Tests::sliceUnary);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void sliceBinaryFloatVector64TestsBinary(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = new float[a.length];
        int origin = RAND.nextInt(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, FloatVector64Tests::sliceBinary);
    }
    ...
    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void sliceFloatVector64TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
    IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, mask, FloatVector64Tests::slice);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void unsliceUnaryFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = new float[a.length];
        int origin = RAND.nextInt(SPECIES.length());
        for (int ic = 0; ic < INVOC_COUNT; ic++) {
        ...
        assertArraysEquals(r, a, origin, FloatVector64Tests::unsliceUnary);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void unsliceBinaryFloatVector64TestsBinary(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = new float[a.length];
        int origin = RAND.nextInt(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, part, FloatVector64Tests::unsliceBinary);
    }
    ...
    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void unsliceFloatVector64TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
    IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, part, mask, FloatVector64Tests::unslice);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void SINFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector64Tests::SIN, FloatVector64Tests::strictSIN);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void EXPFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector64Tests::EXP, FloatVector64Tests::strictEXP);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void LOG1PFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector64Tests::LOG1P, FloatVector64Tests::strictLOG1P);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void LOGFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector64Tests::LOG, FloatVector64Tests::strictLOG);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void LOG10FloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector64Tests::LOG10, FloatVector64Tests::strictLOG10);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void EXPM1FloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector64Tests::EXPM1, FloatVector64Tests::strictEXPM1);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void COSFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector64Tests::COS, FloatVector64Tests::strictCOS);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void TANFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector64Tests::TAN, FloatVector64Tests::strictTAN);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void SINHFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector64Tests::SINH, FloatVector64Tests::strictSINH);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void COSHFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector64Tests::COSH, FloatVector64Tests::strictCOSH);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void TANHFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector64Tests::TANH, FloatVector64Tests::strictTANH);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void ASINFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector64Tests::ASIN, FloatVector64Tests::strictASIN);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void ACOSFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector64Tests::ACOS, FloatVector64Tests::strictACOS);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void ATANFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector64Tests::ATAN, FloatVector64Tests::strictATAN);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void CBRTFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVector64Tests::CBRT, FloatVector64Tests::strictCBRT);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void HYPOTFloatVector64Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, b, FloatVector64Tests::HYPOT, FloatVector64Tests::strictHYPOT);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void POWFloatVector64Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, b, FloatVector64Tests::POW, FloatVector64Tests::strictPOW);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void ATAN2FloatVector64Tests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, b, FloatVector64Tests::ATAN2, FloatVector64Tests::strictATAN2);
    }


    @Test(dataProvider = "floatBinaryOpProvider")
    static void POWFloatVector64TestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEqualsWithinOneUlp(r, a, b, FloatVector64Tests::POW, FloatVector64Tests::strictPOW);
    }
    ...
    static void FMAFloatVector64Tests(IntFunction<float[]> fa, IntFunction<float[]> fb, IntFunction<float[]> fc) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, c, FloatVector64Tests::FMA);
    }
    ...
    static void FMAFloatVector64TestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
        ...
        assertArraysEquals(r, a, b, c, mask, FloatVector64Tests::FMA);
    }

    @Test(dataProvider = "floatTernaryOpProvider")
    static void FMAFloatVector64TestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb, IntFunction<float[]> fc) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] c = fc.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, c, FloatVector64Tests::FMA);
    }

    @Test(dataProvider = "floatTernaryOpProvider")
    static void FMAFloatVector64TestsAltBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb, IntFunction<float[]> fc) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] c = fc.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertAltBroadcastArraysEquals(r, a, b, c, FloatVector64Tests::FMA);
    }

    @Test(dataProvider = "floatTernaryOpMaskProvider")
    static void FMAFloatVector64TestsBroadcastMaskedSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<float[]> fc, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] c = fc.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, c, mask, FloatVector64Tests::FMA);
    }

    @Test(dataProvider = "floatTernaryOpMaskProvider")
    static void FMAFloatVector64TestsAltBroadcastMaskedSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<float[]> fc, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] c = fc.apply(SPECIES.length());
        ...
        assertAltBroadcastArraysEquals(r, a, b, c, mask, FloatVector64Tests::FMA);
    }

    @Test(dataProvider = "floatTernaryOpProvider")
    static void FMAFloatVector64TestsDoubleBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb, IntFunction<float[]> fc) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] c = fc.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertDoubleBroadcastArraysEquals(r, a, b, c, FloatVector64Tests::FMA);
    }
    ...
    @Test(dataProvider = "floatTernaryOpMaskProvider")
    static void FMAFloatVector64TestsDoubleBroadcastMaskedSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<float[]> fc, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] c = fc.apply(SPECIES.length());
        ...
        assertDoubleBroadcastArraysEquals(r, a, b, c, mask, FloatVector64Tests::FMA);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void NEGFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, FloatVector64Tests::NEG);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void NEGMaskedFloatVector64Tests(IntFunction<float[]> fa,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, FloatVector64Tests::NEG);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void ABSFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, FloatVector64Tests::ABS);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void ABSMaskedFloatVector64Tests(IntFunction<float[]> fa,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, FloatVector64Tests::ABS);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void SQRTFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, FloatVector64Tests::SQRT);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void SQRTMaskedFloatVector64Tests(IntFunction<float[]> fa,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, FloatVector64Tests::SQRT);
    }
    ...
    static void maskandFloatVector64Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        ...
        assertArraysEquals(r, a, b, FloatVector64Tests::band);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskorFloatVector64Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, FloatVector64Tests::bor);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskxorFloatVector64Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, FloatVector64Tests::bxor);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskandNotFloatVector64Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, FloatVector64Tests::bandNot);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskeqFloatVector64Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, FloatVector64Tests::beq);
    }
    ...
    static void masknotFloatVector64Tests(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, FloatVector64Tests::unot);
    }
    ...
    static void maskFromToLongFloatVector64Tests(IntFunction<long[]> fa) {
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void eqFloatVector64TestsBroadcastMaskedSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    static void toIntArrayFloatVector64TestsSmokeTest(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    static void toLongArrayFloatVector64TestsSmokeTest(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void toDoubleArrayFloatVector64TestsSmokeTest(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void toStringFloatVector64TestsSmokeTest(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void hashCodeFloatVector64TestsSmokeTest(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void ADDReduceLongFloatVector64Tests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        ...
        assertReductionLongArraysEquals(r, ra, a,
                FloatVector64Tests::ADDReduceLong, FloatVector64Tests::ADDReduceAllLong);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void ADDReduceLongFloatVector64TestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        long[] r = lfr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionLongArraysEqualsMasked(r, ra, a, mask,
                FloatVector64Tests::ADDReduceLongMasked, FloatVector64Tests::ADDReduceAllLongMasked);
    }

    @Test(dataProvider = "floattoLongUnaryOpProvider")
    static void BroadcastLongFloatVector64TestsSmokeTest(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = new float[a.length];
    ...
    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void blendFloatVector64TestsBroadcastLongSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastLongArraysEquals(r, a, b, mask, FloatVector64Tests::blend);
    }


    @Test(dataProvider = "floatUnaryOpSelectFromProvider")
    static void SelectFromFloatVector64Tests(IntFunction<float[]> fa,
    ...
    static void SelectFromTwoVectorFloatVector64Tests(IntFunction<float[]> fa, IntFunction<float[]> fb, IntFunction<float[]> fc) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    static void SelectFromFloatVector64TestsMaskedSmokeTest(IntFunction<float[]> fa,
                                                           BiFunction<Integer,Integer,float[]> fs,
                                                           IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] order = fs.apply(a.length, SPECIES.length());
    ...
    static void shuffleMiscellaneousFloatVector64TestsSmokeTest(BiFunction<Integer,Integer,int[]> fs) {
    ...
    @Test(dataProvider = "shuffleProvider")
    static void shuffleToStringFloatVector64TestsSmokeTest(BiFunction<Integer,Integer,int[]> fs) {
        int[] a = fs.apply(SPECIES.length() * BUFFER_REPS, SPECIES.length());
    ...
    static void shuffleEqualsFloatVector64TestsSmokeTest(BiFunction<Integer,Integer,int[]> fa, BiFunction<Integer,Integer,int[]> fb) {
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskEqualsFloatVector64Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
    ...
    static void maskHashCodeFloatVector64TestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "maskProvider")
    static void maskTrueCountFloatVector64TestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        ...
        assertMaskReductionArraysEquals(r, a, FloatVector64Tests::maskTrueCount);
    }
    ...
    @Test(dataProvider = "maskProvider")
    static void maskLastTrueFloatVector64TestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        int[] r = new int[a.length];
        ...
        assertMaskReductionArraysEquals(r, a, FloatVector64Tests::maskLastTrue);
    }
    ...
    @Test(dataProvider = "maskProvider")
    static void maskFirstTrueFloatVector64TestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        int[] r = new int[a.length];
        ...
        assertMaskReductionArraysEquals(r, a, FloatVector64Tests::maskFirstTrue);
    }

    @Test(dataProvider = "maskProvider")
    static void maskCompressFloatVector64TestsSmokeTest(IntFunction<boolean[]> fa) {
        int trueCount = 0;
        boolean[] a = fa.apply(SPECIES.length());
    ...
    static void indexInRangeFloatVector64TestsSmokeTest(int offset) {
    ...
    @Test(dataProvider = "offsetProvider")
    static void indexInRangeLongFloatVector64TestsSmokeTest(int offset) {
    ...
    static void loopBoundFloatVector64TestsSmokeTest(int length) {
    ...
    @Test(dataProvider = "lengthProvider")
    static void loopBoundLongFloatVector64TestsSmokeTest(int _length) {
        long length = _length;
    ...
    @Test
    static void ElementSizeFloatVector64TestsSmokeTest() {
    ...
    @Test
    static void VectorShapeFloatVector64TestsSmokeTest() {
        FloatVector av = FloatVector.zero(SPECIES);
    ...
    @Test
    static void ShapeWithLanesFloatVector64TestsSmokeTest() {
        FloatVector av = FloatVector.zero(SPECIES);
        VectorShape vsh = av.shape();
    ...
    @Test
    static void ElementTypeFloatVector64TestsSmokeTest() {
        FloatVector av = FloatVector.zero(SPECIES);
    ...
    @Test
    static void VectorTypeFloatVector64TestsSmokeTest() {
        FloatVector av = FloatVector.zero(SPECIES);
        assert(av.species().vectorType() == av.getClass());
    }

    @Test
    static void WithLanesFloatVector64TestsSmokeTest() {
        FloatVector av = FloatVector.zero(SPECIES);
    ...
    @Test
    static void WithShapeFloatVector64TestsSmokeTest() {
        FloatVector av = FloatVector.zero(SPECIES);
        VectorShape vsh = av.shape();
    ...
    @Test
    static void MaskAllTrueFloatVector64TestsSmokeTest() {
        for (int ic = 0; ic < INVOC_COUNT; ic++) {
