 ...
 * @run testng/othervm/timeout=300 -ea -esa -Xbatch -XX:-TieredCompilation FloatVectorMaxTests
 */
...
@Test
public class FloatVectorMaxTests extends AbstractVectorTest {
...
relativeError));
   ...
   static void assertArraysEqualsAssociative(float[] rl, float[] rr, float[] a, float[] b, float[] c, boolean[] mask, FBinOp f) {
    ...
    static void ADDFloatVectorMaxTests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        ...
        assertArraysEquals(r, a, b, FloatVectorMaxTests::ADD);
    }
    ...
    static void ADDFloatVectorMaxTestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
        ...
        assertArraysEquals(r, a, b, mask, FloatVectorMaxTests::ADD);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void SUBFloatVectorMaxTests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, FloatVectorMaxTests::SUB);
    }
    ...
    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void SUBFloatVectorMaxTestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, FloatVectorMaxTests::SUB);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void MULFloatVectorMaxTests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, FloatVectorMaxTests::MUL);
    }
    ...
    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void MULFloatVectorMaxTestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, FloatVectorMaxTests::MUL);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void DIVFloatVectorMaxTests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, FloatVectorMaxTests::DIV);
    }
    ...
    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void DIVFloatVectorMaxTestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, FloatVectorMaxTests::DIV);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void FIRST_NONZEROFloatVectorMaxTests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, FloatVectorMaxTests::FIRST_NONZERO);
    }

    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void FIRST_NONZEROFloatVectorMaxTestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, FloatVectorMaxTests::FIRST_NONZERO);
    }

    @Test(dataProvider = "floatBinaryOpProvider")
    static void addFloatVectorMaxTestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, FloatVectorMaxTests::add);
    }

    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void addFloatVectorMaxTestsBroadcastMaskedSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, FloatVectorMaxTests::add);
    }

    @Test(dataProvider = "floatBinaryOpProvider")
    static void subFloatVectorMaxTestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, FloatVectorMaxTests::sub);
    }

    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void subFloatVectorMaxTestsBroadcastMaskedSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, FloatVectorMaxTests::sub);
    }

    @Test(dataProvider = "floatBinaryOpProvider")
    static void mulFloatVectorMaxTestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, FloatVectorMaxTests::mul);
    }

    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void mulFloatVectorMaxTestsBroadcastMaskedSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, FloatVectorMaxTests::mul);
    }

    @Test(dataProvider = "floatBinaryOpProvider")
    static void divFloatVectorMaxTestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, FloatVectorMaxTests::div);
    }

    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void divFloatVectorMaxTestsBroadcastMaskedSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, FloatVectorMaxTests::div);
    }

    @Test(dataProvider = "floatBinaryOpProvider")
    static void ADDFloatVectorMaxTestsBroadcastLongSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastLongArraysEquals(r, a, b, FloatVectorMaxTests::ADD);
    }

    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void ADDFloatVectorMaxTestsBroadcastMaskedLongSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
    ...
    static void MAXFloatVectorMaxTestsMaskedWithMemOp(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        ...
        assertArraysEquals(r, a, (float)10, mask, FloatVectorMaxTests::MAX);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void MINFloatVectorMaxTests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, FloatVectorMaxTests::MIN);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void MAXFloatVectorMaxTests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, FloatVectorMaxTests::MAX);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void MINFloatVectorMaxTestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, FloatVectorMaxTests::MIN);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void MAXFloatVectorMaxTestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, FloatVectorMaxTests::MAX);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void ADDReduceFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        float ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                FloatVectorMaxTests::ADDReduce, FloatVectorMaxTests::ADDReduceAll, RELATIVE_ROUNDING_ERROR_FACTOR_ADD);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void ADDReduceFloatVectorMaxTestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void MULReduceFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        float ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                FloatVectorMaxTests::MULReduce, FloatVectorMaxTests::MULReduceAll, RELATIVE_ROUNDING_ERROR_FACTOR_MUL);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void MULReduceFloatVectorMaxTestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void MINReduceFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        float ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                FloatVectorMaxTests::MINReduce, FloatVectorMaxTests::MINReduceAll);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void MINReduceFloatVectorMaxTestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                FloatVectorMaxTests::MINReduceMasked, FloatVectorMaxTests::MINReduceAllMasked);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void MAXReduceFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        float ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                FloatVectorMaxTests::MAXReduce, FloatVectorMaxTests::MAXReduceAll);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void MAXReduceFloatVectorMaxTestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                FloatVectorMaxTests::MAXReduceMasked, FloatVectorMaxTests::MAXReduceAllMasked);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void FIRST_NONZEROReduceFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        float ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                FloatVectorMaxTests::FIRST_NONZEROReduce, FloatVectorMaxTests::FIRST_NONZEROReduceAll);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void FIRST_NONZEROReduceFloatVectorMaxTestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                FloatVectorMaxTests::FIRST_NONZEROReduceMasked, FloatVectorMaxTests::FIRST_NONZEROReduceAllMasked);
    }

    @Test(dataProvider = "floatBinaryOpProvider")
    static void withFloatVectorMaxTests(IntFunction<float []> fa, IntFunction<float []> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
    ...
    static void IS_DEFAULTFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    static void IS_DEFAULTMaskedFloatVectorMaxTests(IntFunction<float[]> fa,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    @Test(dataProvider = "floatTestOpProvider")
    static void IS_NEGATIVEFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatTestOpMaskProvider")
    static void IS_NEGATIVEMaskedFloatVectorMaxTests(IntFunction<float[]> fa,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    @Test(dataProvider = "floatTestOpProvider")
    static void IS_FINITEFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatTestOpMaskProvider")
    static void IS_FINITEMaskedFloatVectorMaxTests(IntFunction<float[]> fa,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    @Test(dataProvider = "floatTestOpProvider")
    static void IS_NANFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatTestOpMaskProvider")
    static void IS_NANMaskedFloatVectorMaxTests(IntFunction<float[]> fa,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    @Test(dataProvider = "floatTestOpProvider")
    static void IS_INFINITEFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatTestOpMaskProvider")
    static void IS_INFINITEMaskedFloatVectorMaxTests(IntFunction<float[]> fa,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    static void LTFloatVectorMaxTests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    static void LTFloatVectorMaxTestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void GTFloatVectorMaxTests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void GTFloatVectorMaxTestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void EQFloatVectorMaxTests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void EQFloatVectorMaxTestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void NEFloatVectorMaxTests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void NEFloatVectorMaxTestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void LEFloatVectorMaxTests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void LEFloatVectorMaxTestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void GEFloatVectorMaxTests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void GEFloatVectorMaxTestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void LTFloatVectorMaxTestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void LTFloatVectorMaxTestsBroadcastMaskedSmokeTest(IntFunction<float[]> fa,
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void LTFloatVectorMaxTestsBroadcastLongSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void LTFloatVectorMaxTestsBroadcastLongMaskedSmokeTest(IntFunction<float[]> fa,
                                IntFunction<float[]> fb, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void EQFloatVectorMaxTestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void EQFloatVectorMaxTestsBroadcastMaskedSmokeTest(IntFunction<float[]> fa,
                                IntFunction<float[]> fb, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void EQFloatVectorMaxTestsBroadcastLongSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpMaskProvider")
    static void EQFloatVectorMaxTestsBroadcastLongMaskedSmokeTest(IntFunction<float[]> fa,
                                IntFunction<float[]> fb, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void blendFloatVectorMaxTests(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, FloatVectorMaxTests::blend);
    }

    @Test(dataProvider = "floatUnaryOpShuffleProvider")
    static void RearrangeFloatVectorMaxTests(IntFunction<float[]> fa,
    ...
    static void RearrangeFloatVectorMaxTestsMaskedSmokeTest(IntFunction<float[]> fa,
                                                          BiFunction<Integer,Integer,int[]> fs,
                                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        int[] order = fs.apply(a.length, SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void compressFloatVectorMaxTests(IntFunction<float[]> fa,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void expandFloatVectorMaxTests(IntFunction<float[]> fa,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void getFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void BroadcastFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void ZeroFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = new float[a.length];
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void sliceUnaryFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = new float[a.length];
        ...
        assertArraysEquals(r, a, origin, FloatVectorMaxTests::sliceUnary);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void sliceBinaryFloatVectorMaxTestsBinary(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = new float[a.length];
        int origin = RAND.nextInt(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, FloatVectorMaxTests::sliceBinary);
    }
    ...
    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void sliceFloatVectorMaxTestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
    IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, mask, FloatVectorMaxTests::slice);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void unsliceUnaryFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = new float[a.length];
        int origin = RAND.nextInt(SPECIES.length());
        for (int ic = 0; ic < INVOC_COUNT; ic++) {
        ...
        assertArraysEquals(r, a, origin, FloatVectorMaxTests::unsliceUnary);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void unsliceBinaryFloatVectorMaxTestsBinary(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = new float[a.length];
        int origin = RAND.nextInt(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, part, FloatVectorMaxTests::unsliceBinary);
    }
    ...
    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void unsliceFloatVectorMaxTestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
    IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, part, mask, FloatVectorMaxTests::unslice);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void SINFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVectorMaxTests::SIN, FloatVectorMaxTests::strictSIN);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void EXPFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVectorMaxTests::EXP, FloatVectorMaxTests::strictEXP);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void LOG1PFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVectorMaxTests::LOG1P, FloatVectorMaxTests::strictLOG1P);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void LOGFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVectorMaxTests::LOG, FloatVectorMaxTests::strictLOG);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void LOG10FloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVectorMaxTests::LOG10, FloatVectorMaxTests::strictLOG10);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void EXPM1FloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVectorMaxTests::EXPM1, FloatVectorMaxTests::strictEXPM1);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void COSFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVectorMaxTests::COS, FloatVectorMaxTests::strictCOS);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void TANFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVectorMaxTests::TAN, FloatVectorMaxTests::strictTAN);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void SINHFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVectorMaxTests::SINH, FloatVectorMaxTests::strictSINH);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void COSHFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVectorMaxTests::COSH, FloatVectorMaxTests::strictCOSH);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void TANHFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVectorMaxTests::TANH, FloatVectorMaxTests::strictTANH);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void ASINFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVectorMaxTests::ASIN, FloatVectorMaxTests::strictASIN);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void ACOSFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVectorMaxTests::ACOS, FloatVectorMaxTests::strictACOS);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void ATANFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVectorMaxTests::ATAN, FloatVectorMaxTests::strictATAN);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void CBRTFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, FloatVectorMaxTests::CBRT, FloatVectorMaxTests::strictCBRT);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void HYPOTFloatVectorMaxTests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, b, FloatVectorMaxTests::HYPOT, FloatVectorMaxTests::strictHYPOT);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void POWFloatVectorMaxTests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, b, FloatVectorMaxTests::POW, FloatVectorMaxTests::strictPOW);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void ATAN2FloatVectorMaxTests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, b, FloatVectorMaxTests::ATAN2, FloatVectorMaxTests::strictATAN2);
    }


    @Test(dataProvider = "floatBinaryOpProvider")
    static void POWFloatVectorMaxTestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEqualsWithinOneUlp(r, a, b, FloatVectorMaxTests::POW, FloatVectorMaxTests::strictPOW);
    }
    ...
    static void FMAFloatVectorMaxTests(IntFunction<float[]> fa, IntFunction<float[]> fb, IntFunction<float[]> fc) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, c, FloatVectorMaxTests::FMA);
    }
    ...
    static void FMAFloatVectorMaxTestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
        ...
        assertArraysEquals(r, a, b, c, mask, FloatVectorMaxTests::FMA);
    }

    @Test(dataProvider = "floatTernaryOpProvider")
    static void FMAFloatVectorMaxTestsBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb, IntFunction<float[]> fc) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] c = fc.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, c, FloatVectorMaxTests::FMA);
    }

    @Test(dataProvider = "floatTernaryOpProvider")
    static void FMAFloatVectorMaxTestsAltBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb, IntFunction<float[]> fc) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] c = fc.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertAltBroadcastArraysEquals(r, a, b, c, FloatVectorMaxTests::FMA);
    }

    @Test(dataProvider = "floatTernaryOpMaskProvider")
    static void FMAFloatVectorMaxTestsBroadcastMaskedSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<float[]> fc, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] c = fc.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, c, mask, FloatVectorMaxTests::FMA);
    }

    @Test(dataProvider = "floatTernaryOpMaskProvider")
    static void FMAFloatVectorMaxTestsAltBroadcastMaskedSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<float[]> fc, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] c = fc.apply(SPECIES.length());
        ...
        assertAltBroadcastArraysEquals(r, a, b, c, mask, FloatVectorMaxTests::FMA);
    }

    @Test(dataProvider = "floatTernaryOpProvider")
    static void FMAFloatVectorMaxTestsDoubleBroadcastSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb, IntFunction<float[]> fc) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] c = fc.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertDoubleBroadcastArraysEquals(r, a, b, c, FloatVectorMaxTests::FMA);
    }
    ...
    @Test(dataProvider = "floatTernaryOpMaskProvider")
    static void FMAFloatVectorMaxTestsDoubleBroadcastMaskedSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<float[]> fc, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] c = fc.apply(SPECIES.length());
        ...
        assertDoubleBroadcastArraysEquals(r, a, b, c, mask, FloatVectorMaxTests::FMA);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void NEGFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, FloatVectorMaxTests::NEG);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void NEGMaskedFloatVectorMaxTests(IntFunction<float[]> fa,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, FloatVectorMaxTests::NEG);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void ABSFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, FloatVectorMaxTests::ABS);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void ABSMaskedFloatVectorMaxTests(IntFunction<float[]> fa,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, FloatVectorMaxTests::ABS);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void SQRTFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, FloatVectorMaxTests::SQRT);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void SQRTMaskedFloatVectorMaxTests(IntFunction<float[]> fa,
                                                IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, FloatVectorMaxTests::SQRT);
    }
    ...
    static void maskandFloatVectorMaxTests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        ...
        assertArraysEquals(r, a, b, FloatVectorMaxTests::band);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskorFloatVectorMaxTests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, FloatVectorMaxTests::bor);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskxorFloatVectorMaxTests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, FloatVectorMaxTests::bxor);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskandNotFloatVectorMaxTests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, FloatVectorMaxTests::bandNot);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskeqFloatVectorMaxTests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, FloatVectorMaxTests::beq);
    }
    ...
    static void masknotFloatVectorMaxTests(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, FloatVectorMaxTests::unot);
    }
    ...
    static void maskFromToLongFloatVectorMaxTests(IntFunction<long[]> fa) {
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void eqFloatVectorMaxTestsBroadcastMaskedSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    static void toIntArrayFloatVectorMaxTestsSmokeTest(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    static void toLongArrayFloatVectorMaxTestsSmokeTest(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void toDoubleArrayFloatVectorMaxTestsSmokeTest(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void toStringFloatVectorMaxTestsSmokeTest(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void hashCodeFloatVectorMaxTestsSmokeTest(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void ADDReduceLongFloatVectorMaxTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        ...
        assertReductionLongArraysEquals(r, ra, a,
                FloatVectorMaxTests::ADDReduceLong, FloatVectorMaxTests::ADDReduceAllLong);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void ADDReduceLongFloatVectorMaxTestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        long[] r = lfr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionLongArraysEqualsMasked(r, ra, a, mask,
                FloatVectorMaxTests::ADDReduceLongMasked, FloatVectorMaxTests::ADDReduceAllLongMasked);
    }

    @Test(dataProvider = "floattoLongUnaryOpProvider")
    static void BroadcastLongFloatVectorMaxTestsSmokeTest(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = new float[a.length];
    ...
    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void blendFloatVectorMaxTestsBroadcastLongSmokeTest(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastLongArraysEquals(r, a, b, mask, FloatVectorMaxTests::blend);
    }


    @Test(dataProvider = "floatUnaryOpSelectFromProvider")
    static void SelectFromFloatVectorMaxTests(IntFunction<float[]> fa,
    ...
    static void SelectFromTwoVectorFloatVectorMaxTests(IntFunction<float[]> fa, IntFunction<float[]> fb, IntFunction<float[]> fc) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    static void SelectFromFloatVectorMaxTestsMaskedSmokeTest(IntFunction<float[]> fa,
                                                           BiFunction<Integer,Integer,float[]> fs,
                                                           IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] order = fs.apply(a.length, SPECIES.length());
    ...
    static void shuffleMiscellaneousFloatVectorMaxTestsSmokeTest(BiFunction<Integer,Integer,int[]> fs) {
    ...
    @Test(dataProvider = "shuffleProvider")
    static void shuffleToStringFloatVectorMaxTestsSmokeTest(BiFunction<Integer,Integer,int[]> fs) {
        int[] a = fs.apply(SPECIES.length() * BUFFER_REPS, SPECIES.length());
    ...
    static void shuffleEqualsFloatVectorMaxTestsSmokeTest(BiFunction<Integer,Integer,int[]> fa, BiFunction<Integer,Integer,int[]> fb) {
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskEqualsFloatVectorMaxTests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
    ...
    static void maskHashCodeFloatVectorMaxTestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "maskProvider")
    static void maskTrueCountFloatVectorMaxTestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        ...
        assertMaskReductionArraysEquals(r, a, FloatVectorMaxTests::maskTrueCount);
    }
    ...
    @Test(dataProvider = "maskProvider")
    static void maskLastTrueFloatVectorMaxTestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        int[] r = new int[a.length];
        ...
        assertMaskReductionArraysEquals(r, a, FloatVectorMaxTests::maskLastTrue);
    }
    ...
    @Test(dataProvider = "maskProvider")
    static void maskFirstTrueFloatVectorMaxTestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        int[] r = new int[a.length];
        ...
        assertMaskReductionArraysEquals(r, a, FloatVectorMaxTests::maskFirstTrue);
    }

    @Test(dataProvider = "maskProvider")
    static void maskCompressFloatVectorMaxTestsSmokeTest(IntFunction<boolean[]> fa) {
        int trueCount = 0;
        boolean[] a = fa.apply(SPECIES.length());
    ...
    static void indexInRangeFloatVectorMaxTestsSmokeTest(int offset) {
    ...
    @Test(dataProvider = "offsetProvider")
    static void indexInRangeLongFloatVectorMaxTestsSmokeTest(int offset) {
    ...
    static void loopBoundFloatVectorMaxTestsSmokeTest(int length) {
    ...
    @Test(dataProvider = "lengthProvider")
    static void loopBoundLongFloatVectorMaxTestsSmokeTest(int _length) {
        long length = _length;
    ...
    @Test
    static void ElementSizeFloatVectorMaxTestsSmokeTest() {
    ...
    @Test
    static void VectorShapeFloatVectorMaxTestsSmokeTest() {
        FloatVector av = FloatVector.zero(SPECIES);
    ...
    @Test
    static void ShapeWithLanesFloatVectorMaxTestsSmokeTest() {
        FloatVector av = FloatVector.zero(SPECIES);
        VectorShape vsh = av.shape();
    ...
    @Test
    static void SpeciesElementSizeFloatVectorMaxTestsSmokeTest() {
        FloatVector av = FloatVector.zero(SPECIES);
        assert(av.species().elementSize() == Float.SIZE);
    }

    @Test
    static void VectorTypeFloatVectorMaxTestsSmokeTest() {
        FloatVector av = FloatVector.zero(SPECIES);
        assert(av.species().vectorType() == av.getClass());
    }

    @Test
    static void WithLanesFloatVectorMaxTestsSmokeTest() {
        FloatVector av = FloatVector.zero(SPECIES);
    ...
    @Test
    static void WithShapeFloatVectorMaxTestsSmokeTest() {
        FloatVector av = FloatVector.zero(SPECIES);
        VectorShape vsh = av.shape();
    ...
    @Test
    static void MaskAllTrueFloatVectorMaxTestsSmokeTest() {
        for (int ic = 0; ic < INVOC_COUNT; ic++) {
