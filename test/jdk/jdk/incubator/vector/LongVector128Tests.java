 ...
 * @run testng/othervm/timeout=300 -ea -esa -Xbatch -XX:-TieredCompilation LongVector128Tests
 */
...
@Test
public class LongVector128Tests extends AbstractVectorTest {
    ...
    static void assertIntersectArraysEquals(boolean[] r, long[] a, long[] b, int vector_len) {
        int i = 0, j = 0;
        try {
            for (; i < a.length; i += vector_len) {
                for (j = 0; j < vector_len; j++) {
   ...
   public Object[][] longSaturatingUnaryOpMaskProvider() {
    ...
    static void ADDLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::ADD);
    }
    ...
    static void ADDLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
        ...
        assertArraysEquals(r, a, b, mask, LongVector128Tests::ADD);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void SUBLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::SUB);
    }
    ...
    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void SUBLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector128Tests::SUB);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void MULLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::MUL);
    }
    ...
    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void MULLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector128Tests::MUL);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void DIVLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::DIV);
    }
    ...
    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void DIVLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector128Tests::DIV);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void FIRST_NONZEROLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::FIRST_NONZERO);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void FIRST_NONZEROLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector128Tests::FIRST_NONZERO);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void ANDLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::AND);
    }
    ...
    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void ANDLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector128Tests::AND);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void AND_NOTLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::AND_NOT);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void AND_NOTLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector128Tests::AND_NOT);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void ORLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::OR);
    }
    ...
    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void ORLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector128Tests::OR);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void XORLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::XOR);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void XORLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector128Tests::XOR);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void COMPRESS_BITSLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::COMPRESS_BITS);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void COMPRESS_BITSLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector128Tests::COMPRESS_BITS);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void EXPAND_BITSLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::EXPAND_BITS);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void EXPAND_BITSLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector128Tests::EXPAND_BITS);
    }

    @Test(dataProvider = "longBinaryOpProvider")
    static void addLongVector128TestsBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, LongVector128Tests::add);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void addLongVector128TestsBroadcastMaskedSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, LongVector128Tests::add);
    }

    @Test(dataProvider = "longBinaryOpProvider")
    static void subLongVector128TestsBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, LongVector128Tests::sub);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void subLongVector128TestsBroadcastMaskedSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, LongVector128Tests::sub);
    }

    @Test(dataProvider = "longBinaryOpProvider")
    static void mulLongVector128TestsBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, LongVector128Tests::mul);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void mulLongVector128TestsBroadcastMaskedSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, LongVector128Tests::mul);
    }

    @Test(dataProvider = "longBinaryOpProvider")
    static void divLongVector128TestsBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, LongVector128Tests::div);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void divLongVector128TestsBroadcastMaskedSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, LongVector128Tests::div);
    }

    @Test(dataProvider = "longBinaryOpProvider")
    static void ORLongVector128TestsBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, LongVector128Tests::OR);
    }
    ...
    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void ORLongVector128TestsBroadcastMaskedSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, LongVector128Tests::OR);
    }

    @Test(dataProvider = "longBinaryOpProvider")
    static void ANDLongVector128TestsBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, LongVector128Tests::AND);
    }
    ...
    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void ANDLongVector128TestsBroadcastMaskedSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, LongVector128Tests::AND);
    }

    @Test(dataProvider = "longBinaryOpProvider")
    static void ORLongVector128TestsBroadcastLongSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastLongArraysEquals(r, a, b, LongVector128Tests::OR);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void ORLongVector128TestsBroadcastMaskedLongSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastLongArraysEquals(r, a, b, mask, LongVector128Tests::OR);
    }

    @Test(dataProvider = "longBinaryOpProvider")
    static void ADDLongVector128TestsBroadcastLongSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastLongArraysEquals(r, a, b, LongVector128Tests::ADD);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void ADDLongVector128TestsBroadcastMaskedLongSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastLongArraysEquals(r, a, b, mask, LongVector128Tests::ADD);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void LSHLLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::LSHL);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void LSHLLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector128Tests::LSHL);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void ASHRLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::ASHR);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void ASHRLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector128Tests::ASHR);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void LSHRLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::LSHR);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void LSHRLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector128Tests::LSHR);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void LSHLLongVector128TestsScalarShift(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, LongVector128Tests::LSHL_unary);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void LSHLLongVector128TestsScalarShiftMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, mask, LongVector128Tests::LSHL_unary);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void LSHRLongVector128TestsScalarShift(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, LongVector128Tests::LSHR_unary);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void LSHRLongVector128TestsScalarShiftMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, mask, LongVector128Tests::LSHR_unary);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void ASHRLongVector128TestsScalarShift(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, LongVector128Tests::ASHR_unary);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void ASHRLongVector128TestsScalarShiftMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, mask, LongVector128Tests::ASHR_unary);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void RORLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::ROR);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void RORLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector128Tests::ROR);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void ROLLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::ROL);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void ROLLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector128Tests::ROL);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void RORLongVector128TestsScalarShift(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, LongVector128Tests::ROR_unary);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void RORLongVector128TestsScalarShiftMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, mask, LongVector128Tests::ROR_unary);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void ROLLongVector128TestsScalarShift(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, LongVector128Tests::ROL_unary);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void ROLLongVector128TestsScalarShiftMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, mask, LongVector128Tests::ROL_unary);
    }
    ...
    static void LSHRLongVector128TestsScalarShiftConst(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, LongVector128Tests::LSHR_binary_const);
    }

    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void LSHRLongVector128TestsScalarShiftMaskedConst(IntFunction<long[]> fa,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, mask, LongVector128Tests::LSHR_binary_const);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void LSHLLongVector128TestsScalarShiftConst(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, LongVector128Tests::LSHL_binary_const);
    }

    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void LSHLLongVector128TestsScalarShiftMaskedConst(IntFunction<long[]> fa,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, mask, LongVector128Tests::LSHL_binary_const);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void ASHRLongVector128TestsScalarShiftConst(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, LongVector128Tests::ASHR_binary_const);
    }

    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void ASHRLongVector128TestsScalarShiftMaskedConst(IntFunction<long[]> fa,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, mask, LongVector128Tests::ASHR_binary_const);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void RORLongVector128TestsScalarShiftConst(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, LongVector128Tests::ROR_binary_const);
    }

    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void RORLongVector128TestsScalarShiftMaskedConst(IntFunction<long[]> fa,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, mask, LongVector128Tests::ROR_binary_const);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void ROLLongVector128TestsScalarShiftConst(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, LongVector128Tests::ROL_binary_const);
    }

    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void ROLLongVector128TestsScalarShiftMaskedConst(IntFunction<long[]> fa,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, mask, LongVector128Tests::ROL_binary_const);
    }
    ...
    static void MAXLongVector128TestsMaskedWithMemOp(IntFunction<long[]> fa, IntFunction<boolean[]> fm) {
        ...
        assertArraysEquals(r, a, (long)10, mask, LongVector128Tests::MAX);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void MINLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::MIN);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void MAXLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::MAX);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void UMINLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::UMIN);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void UMINLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector128Tests::UMIN);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void UMAXLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::UMAX);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void UMAXLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector128Tests::UMAX);
    }
    ...
    static void SADDLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::SADD);
    }

    @Test(dataProvider = "longSaturatingBinaryOpMaskProvider")
    static void SADDLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector128Tests::SADD);
    }
    ...
    @Test(dataProvider = "longSaturatingBinaryOpProvider")
    static void SSUBLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::SSUB);
    }

    @Test(dataProvider = "longSaturatingBinaryOpMaskProvider")
    static void SSUBLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector128Tests::SSUB);
    }
    ...
    @Test(dataProvider = "longSaturatingBinaryOpProvider")
    static void SUADDLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::SUADD);
    }

    @Test(dataProvider = "longSaturatingBinaryOpMaskProvider")
    static void SUADDLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector128Tests::SUADD);
    }
    ...
    @Test(dataProvider = "longSaturatingBinaryOpProvider")
    static void SUSUBLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::SUSUB);
    }

    @Test(dataProvider = "longSaturatingBinaryOpMaskProvider")
    static void SUSUBLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector128Tests::SUSUB);
    }

    @Test(dataProvider = "longBinaryOpProvider")
    static void MINLongVector128TestsBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, LongVector128Tests::MIN);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void MAXLongVector128TestsBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, LongVector128Tests::MAX);
    }
    ...
    static void SUADDAssocLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb, IntFunction<long[]> fc) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        ...
        assertArraysEqualsAssociative(rl, rr, a, b, c, LongVector128Tests::SUADD);
    }

    @Test(dataProvider = "longSaturatingBinaryOpAssocMaskProvider")
    static void SUADDAssocLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
        ...
        assertArraysEqualsAssociative(rl, rr, a, b, c, mask, LongVector128Tests::SUADD);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void ANDReduceLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        long ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                LongVector128Tests::ANDReduce, LongVector128Tests::ANDReduceAll);
    }
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void ANDReduceLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                LongVector128Tests::ANDReduceMasked, LongVector128Tests::ANDReduceAllMasked);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void ORReduceLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        long ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                LongVector128Tests::ORReduce, LongVector128Tests::ORReduceAll);
    }
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void ORReduceLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                LongVector128Tests::ORReduceMasked, LongVector128Tests::ORReduceAllMasked);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void XORReduceLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        long ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                LongVector128Tests::XORReduce, LongVector128Tests::XORReduceAll);
    }
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void XORReduceLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                LongVector128Tests::XORReduceMasked, LongVector128Tests::XORReduceAllMasked);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void ADDReduceLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        long ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                LongVector128Tests::ADDReduce, LongVector128Tests::ADDReduceAll);
    }
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void ADDReduceLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                LongVector128Tests::ADDReduceMasked, LongVector128Tests::ADDReduceAllMasked);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void MULReduceLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        long ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                LongVector128Tests::MULReduce, LongVector128Tests::MULReduceAll);
    }
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void MULReduceLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                LongVector128Tests::MULReduceMasked, LongVector128Tests::MULReduceAllMasked);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void MINReduceLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        long ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                LongVector128Tests::MINReduce, LongVector128Tests::MINReduceAll);
    }
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void MINReduceLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                LongVector128Tests::MINReduceMasked, LongVector128Tests::MINReduceAllMasked);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void MAXReduceLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        long ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                LongVector128Tests::MAXReduce, LongVector128Tests::MAXReduceAll);
    }
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void MAXReduceLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                LongVector128Tests::MAXReduceMasked, LongVector128Tests::MAXReduceAllMasked);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void UMINReduceLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        long ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                LongVector128Tests::UMINReduce, LongVector128Tests::UMINReduceAll);
    }
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void UMINReduceLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                LongVector128Tests::UMINReduceMasked, LongVector128Tests::UMINReduceAllMasked);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void UMAXReduceLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        long ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                LongVector128Tests::UMAXReduce, LongVector128Tests::UMAXReduceAll);
    }
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void UMAXReduceLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                LongVector128Tests::UMAXReduceMasked, LongVector128Tests::UMAXReduceAllMasked);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void FIRST_NONZEROReduceLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        long ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                LongVector128Tests::FIRST_NONZEROReduce, LongVector128Tests::FIRST_NONZEROReduceAll);
    }
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void FIRST_NONZEROReduceLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                LongVector128Tests::FIRST_NONZEROReduceMasked, LongVector128Tests::FIRST_NONZEROReduceAllMasked);
    }
    ...
    static void anyTrueLongVector128Tests(IntFunction<boolean[]> fm) {
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertReductionBoolArraysEquals(r, mask, LongVector128Tests::anyTrue);
    }
    ...
    @Test(dataProvider = "boolUnaryOpProvider")
    static void allTrueLongVector128Tests(IntFunction<boolean[]> fm) {
        boolean[] mask = fm.apply(SPECIES.length());
        boolean[] r = fmr.apply(SPECIES.length());
        ...
        assertReductionBoolArraysEquals(r, mask, LongVector128Tests::allTrue);
    }
    ...
    static void SUADDReduceLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        long ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                LongVector128Tests::SUADDReduce, LongVector128Tests::SUADDReduceAll);
    }
    ...
    static void SUADDReduceLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                LongVector128Tests::SUADDReduceMasked, LongVector128Tests::SUADDReduceAllMasked);
    }

    @Test(dataProvider = "longBinaryOpProvider")
    static void withLongVector128Tests(IntFunction<long []> fa, IntFunction<long []> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
    ...
    static void IS_DEFAULTLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
    ...
    static void IS_DEFAULTMaskedLongVector128Tests(IntFunction<long[]> fa,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    @Test(dataProvider = "longTestOpProvider")
    static void IS_NEGATIVELongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longTestOpMaskProvider")
    static void IS_NEGATIVEMaskedLongVector128Tests(IntFunction<long[]> fa,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    static void LTLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    static void LTLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpProvider")
    static void GTLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpMaskProvider")
    static void GTLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpProvider")
    static void EQLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpMaskProvider")
    static void EQLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpProvider")
    static void NELongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpMaskProvider")
    static void NELongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpProvider")
    static void LELongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpMaskProvider")
    static void LELongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpProvider")
    static void GELongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpMaskProvider")
    static void GELongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpProvider")
    static void ULTLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpMaskProvider")
    static void ULTLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpProvider")
    static void UGTLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpMaskProvider")
    static void UGTLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpProvider")
    static void ULELongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpMaskProvider")
    static void ULELongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpProvider")
    static void UGELongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpMaskProvider")
    static void UGELongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpProvider")
    static void LTLongVector128TestsBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpMaskProvider")
    static void LTLongVector128TestsBroadcastMaskedSmokeTest(IntFunction<long[]> fa,
    ...
    @Test(dataProvider = "longCompareOpProvider")
    static void EQLongVector128TestsBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpMaskProvider")
    static void EQLongVector128TestsBroadcastMaskedSmokeTest(IntFunction<long[]> fa,
                                IntFunction<long[]> fb, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void blendLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector128Tests::blend);
    }

    @Test(dataProvider = "longUnaryOpShuffleProvider")
    static void RearrangeLongVector128Tests(IntFunction<long[]> fa,
    ...
    static void RearrangeLongVector128TestsMaskedSmokeTest(IntFunction<long[]> fa,
                                                          BiFunction<Integer,Integer,int[]> fs,
                                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        int[] order = fs.apply(a.length, SPECIES.length());
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void compressLongVector128Tests(IntFunction<long[]> fa,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void expandLongVector128Tests(IntFunction<long[]> fa,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void intersectLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void getLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void BroadcastLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void ZeroLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = new long[a.length];
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void sliceUnaryLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = new long[a.length];
        ...
        assertArraysEquals(r, a, origin, LongVector128Tests::sliceUnary);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void sliceBinaryLongVector128TestsBinary(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = new long[a.length];
        int origin = RAND.nextInt(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, LongVector128Tests::sliceBinary);
    }
    ...
    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void sliceLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
    IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, mask, LongVector128Tests::slice);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void unsliceUnaryLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = new long[a.length];
        int origin = RAND.nextInt(SPECIES.length());
        for (int ic = 0; ic < INVOC_COUNT; ic++) {
        ...
        assertArraysEquals(r, a, origin, LongVector128Tests::unsliceUnary);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void unsliceBinaryLongVector128TestsBinary(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = new long[a.length];
        int origin = RAND.nextInt(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, part, LongVector128Tests::unsliceBinary);
    }
    ...
    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void unsliceLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
    IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, part, mask, LongVector128Tests::unslice);
    }
    ...
    static void BITWISE_BLENDLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb, IntFunction<long[]> fc) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] c = fc.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, c, LongVector128Tests::BITWISE_BLEND);
    }

    @Test(dataProvider = "longTernaryOpProvider")
    static void bitwiseBlendLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb, IntFunction<long[]> fc) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] c = fc.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, c, LongVector128Tests::bitwiseBlend);
    }

    @Test(dataProvider = "longTernaryOpMaskProvider")
    static void BITWISE_BLENDLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<long[]> fc, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] c = fc.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, c, mask, LongVector128Tests::BITWISE_BLEND);
    }

    @Test(dataProvider = "longTernaryOpProvider")
    static void BITWISE_BLENDLongVector128TestsBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb, IntFunction<long[]> fc) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] c = fc.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, c, LongVector128Tests::BITWISE_BLEND);
    }

    @Test(dataProvider = "longTernaryOpProvider")
    static void BITWISE_BLENDLongVector128TestsAltBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb, IntFunction<long[]> fc) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] c = fc.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertAltBroadcastArraysEquals(r, a, b, c, LongVector128Tests::BITWISE_BLEND);
    }

    @Test(dataProvider = "longTernaryOpProvider")
    static void bitwiseBlendLongVector128TestsBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb, IntFunction<long[]> fc) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] c = fc.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, c, LongVector128Tests::bitwiseBlend);
    }

    @Test(dataProvider = "longTernaryOpProvider")
    static void bitwiseBlendLongVector128TestsAltBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb, IntFunction<long[]> fc) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] c = fc.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertAltBroadcastArraysEquals(r, a, b, c, LongVector128Tests::bitwiseBlend);
    }

    @Test(dataProvider = "longTernaryOpMaskProvider")
    static void BITWISE_BLENDLongVector128TestsBroadcastMaskedSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<long[]> fc, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] c = fc.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, c, mask, LongVector128Tests::BITWISE_BLEND);
    }

    @Test(dataProvider = "longTernaryOpMaskProvider")
    static void BITWISE_BLENDLongVector128TestsAltBroadcastMaskedSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<long[]> fc, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] c = fc.apply(SPECIES.length());
        ...
        assertAltBroadcastArraysEquals(r, a, b, c, mask, LongVector128Tests::BITWISE_BLEND);
    }

    @Test(dataProvider = "longTernaryOpProvider")
    static void BITWISE_BLENDLongVector128TestsDoubleBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb, IntFunction<long[]> fc) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] c = fc.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertDoubleBroadcastArraysEquals(r, a, b, c, LongVector128Tests::BITWISE_BLEND);
    }

    @Test(dataProvider = "longTernaryOpProvider")
    static void bitwiseBlendLongVector128TestsDoubleBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb, IntFunction<long[]> fc) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] c = fc.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertDoubleBroadcastArraysEquals(r, a, b, c, LongVector128Tests::bitwiseBlend);
    }

    @Test(dataProvider = "longTernaryOpMaskProvider")
    static void BITWISE_BLENDLongVector128TestsDoubleBroadcastMaskedSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<long[]> fc, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] c = fc.apply(SPECIES.length());
        ...
        assertDoubleBroadcastArraysEquals(r, a, b, c, mask, LongVector128Tests::BITWISE_BLEND);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void NEGLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, LongVector128Tests::NEG);
    }
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void NEGMaskedLongVector128Tests(IntFunction<long[]> fa,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, LongVector128Tests::NEG);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void ABSLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, LongVector128Tests::ABS);
    }
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void ABSMaskedLongVector128Tests(IntFunction<long[]> fa,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, LongVector128Tests::ABS);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void NOTLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, LongVector128Tests::NOT);
    }
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void NOTMaskedLongVector128Tests(IntFunction<long[]> fa,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, LongVector128Tests::NOT);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void ZOMOLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, LongVector128Tests::ZOMO);
    }

    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void ZOMOMaskedLongVector128Tests(IntFunction<long[]> fa,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, LongVector128Tests::ZOMO);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void BIT_COUNTLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, LongVector128Tests::BIT_COUNT);
    }

    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void BIT_COUNTMaskedLongVector128Tests(IntFunction<long[]> fa,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, LongVector128Tests::BIT_COUNT);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void TRAILING_ZEROS_COUNTLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, LongVector128Tests::TRAILING_ZEROS_COUNT);
    }

    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void TRAILING_ZEROS_COUNTMaskedLongVector128Tests(IntFunction<long[]> fa,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, LongVector128Tests::TRAILING_ZEROS_COUNT);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void LEADING_ZEROS_COUNTLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, LongVector128Tests::LEADING_ZEROS_COUNT);
    }

    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void LEADING_ZEROS_COUNTMaskedLongVector128Tests(IntFunction<long[]> fa,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, LongVector128Tests::LEADING_ZEROS_COUNT);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void REVERSELongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, LongVector128Tests::REVERSE);
    }

    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void REVERSEMaskedLongVector128Tests(IntFunction<long[]> fa,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, LongVector128Tests::REVERSE);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void REVERSE_BYTESLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, LongVector128Tests::REVERSE_BYTES);
    }

    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void REVERSE_BYTESMaskedLongVector128Tests(IntFunction<long[]> fa,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, LongVector128Tests::REVERSE_BYTES);
    }
    ...
    static void maskandLongVector128Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::band);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskorLongVector128Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::bor);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskxorLongVector128Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::bxor);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskandNotLongVector128Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::bandNot);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskeqLongVector128Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, LongVector128Tests::beq);
    }
    ...
    static void masknotLongVector128Tests(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, LongVector128Tests::unot);
    }
    ...
    static void maskFromToLongLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = new long[a.length];
    ...
    @Test(dataProvider = "longCompareOpProvider")
    static void eqLongVector128TestsBroadcastMaskedSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    static void toIntArrayLongVector128TestsSmokeTest(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void toLongArrayLongVector128TestsSmokeTest(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void toDoubleArrayLongVector128TestsSmokeTest(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void toStringLongVector128TestsSmokeTest(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void hashCodeLongVector128TestsSmokeTest(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void ADDReduceLongLongVector128Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        long ra = 0;
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void ADDReduceLongLongVector128TestsMasked(IntFunction<long[]> fa, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    static void SelectFromLongVector128Tests(IntFunction<long[]> fa,
    ...
    static void SelectFromTwoVectorLongVector128Tests(IntFunction<long[]> fa, IntFunction<long[]> fb, IntFunction<long[]> fc) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    static void SelectFromLongVector128TestsMaskedSmokeTest(IntFunction<long[]> fa,
                                                           BiFunction<Integer,Integer,long[]> fs,
                                                           IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] order = fs.apply(a.length, SPECIES.length());
    ...
    static void shuffleMiscellaneousLongVector128TestsSmokeTest(BiFunction<Integer,Integer,int[]> fs) {
    ...
    @Test(dataProvider = "shuffleProvider")
    static void shuffleToStringLongVector128TestsSmokeTest(BiFunction<Integer,Integer,int[]> fs) {
        int[] a = fs.apply(SPECIES.length() * BUFFER_REPS, SPECIES.length());
    ...
    static void shuffleEqualsLongVector128TestsSmokeTest(BiFunction<Integer,Integer,int[]> fa, BiFunction<Integer,Integer,int[]> fb) {
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskEqualsLongVector128Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
    ...
    static void maskHashCodeLongVector128TestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "maskProvider")
    static void maskTrueCountLongVector128TestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        ...
        assertMaskReductionArraysEquals(r, a, LongVector128Tests::maskTrueCount);
    }
    ...
    @Test(dataProvider = "maskProvider")
    static void maskLastTrueLongVector128TestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        int[] r = new int[a.length];
        ...
        assertMaskReductionArraysEquals(r, a, LongVector128Tests::maskLastTrue);
    }
    ...
    @Test(dataProvider = "maskProvider")
    static void maskFirstTrueLongVector128TestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        int[] r = new int[a.length];
        ...
        assertMaskReductionArraysEquals(r, a, LongVector128Tests::maskFirstTrue);
    }

    @Test(dataProvider = "maskProvider")
    static void maskCompressLongVector128TestsSmokeTest(IntFunction<boolean[]> fa) {
        int trueCount = 0;
        boolean[] a = fa.apply(SPECIES.length());
    ...
    static void indexInRangeLongVector128TestsSmokeTest(int offset) {
    ...
    @Test(dataProvider = "offsetProvider")
    static void indexInRangeLongLongVector128TestsSmokeTest(int offset) {
    ...
    static void loopBoundLongVector128TestsSmokeTest(int length) {
    ...
    @Test(dataProvider = "lengthProvider")
    static void loopBoundLongLongVector128TestsSmokeTest(int _length) {
        long length = _length;
    ...
    @Test
    static void VectorShapeLongVector128TestsSmokeTest() {
        LongVector av = LongVector.zero(SPECIES);
    ...
    @Test
    static void ShapeWithLanesLongVector128TestsSmokeTest() {
        LongVector av = LongVector.zero(SPECIES);
        VectorShape vsh = av.shape();
    ...
    @Test
    static void ElementTypeLongVector128TestsSmokeTest() {
        LongVector av = LongVector.zero(SPECIES);
        assert(av.species().elementType() == long.class);
    }

    @Test
    static void SpeciesElementSizeLongVector128TestsSmokeTest() {
        LongVector av = LongVector.zero(SPECIES);
        assert(av.species().elementSize() == Long.SIZE);
    }

    @Test
    static void VectorTypeLongVector128TestsSmokeTest() {
        LongVector av = LongVector.zero(SPECIES);
        assert(av.species().vectorType() == av.getClass());
    }

    @Test
    static void WithLanesLongVector128TestsSmokeTest() {
        LongVector av = LongVector.zero(SPECIES);
    ...
    @Test
    static void WithShapeLongVector128TestsSmokeTest() {
        LongVector av = LongVector.zero(SPECIES);
        VectorShape vsh = av.shape();
    ...
    @Test
    static void MaskAllTrueLongVector128TestsSmokeTest() {
        for (int ic = 0; ic < INVOC_COUNT; ic++) {
