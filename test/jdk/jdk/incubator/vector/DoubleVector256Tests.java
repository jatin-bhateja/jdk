 ...
 * @run testng/othervm/timeout=300 -ea -esa -Xbatch -XX:-TieredCompilation DoubleVector256Tests
 */
...
@Test
public class DoubleVector256Tests extends AbstractVectorTest {
...
relativeError));
   ...
   static void assertArraysEqualsAssociative(double[] rl, double[] rr, double[] a, double[] b, double[] c, boolean[] mask, FBinOp f) {
    ...
    static void ADDDoubleVector256Tests(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        ...
        assertArraysEquals(r, a, b, DoubleVector256Tests::ADD);
    }
    ...
    static void ADDDoubleVector256TestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
        ...
        assertArraysEquals(r, a, b, mask, DoubleVector256Tests::ADD);
    }
    ...
    @Test(dataProvider = "doubleBinaryOpProvider")
    static void SUBDoubleVector256Tests(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, DoubleVector256Tests::SUB);
    }
    ...
    @Test(dataProvider = "doubleBinaryOpMaskProvider")
    static void SUBDoubleVector256TestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, DoubleVector256Tests::SUB);
    }
    ...
    @Test(dataProvider = "doubleBinaryOpProvider")
    static void MULDoubleVector256Tests(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, DoubleVector256Tests::MUL);
    }
    ...
    @Test(dataProvider = "doubleBinaryOpMaskProvider")
    static void MULDoubleVector256TestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, DoubleVector256Tests::MUL);
    }
    ...
    @Test(dataProvider = "doubleBinaryOpProvider")
    static void DIVDoubleVector256Tests(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, DoubleVector256Tests::DIV);
    }
    ...
    @Test(dataProvider = "doubleBinaryOpMaskProvider")
    static void DIVDoubleVector256TestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, DoubleVector256Tests::DIV);
    }
    ...
    @Test(dataProvider = "doubleBinaryOpProvider")
    static void FIRST_NONZERODoubleVector256Tests(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, DoubleVector256Tests::FIRST_NONZERO);
    }

    @Test(dataProvider = "doubleBinaryOpMaskProvider")
    static void FIRST_NONZERODoubleVector256TestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, DoubleVector256Tests::FIRST_NONZERO);
    }

    @Test(dataProvider = "doubleBinaryOpProvider")
    static void addDoubleVector256TestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, DoubleVector256Tests::add);
    }

    @Test(dataProvider = "doubleBinaryOpMaskProvider")
    static void addDoubleVector256TestsBroadcastMaskedSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, DoubleVector256Tests::add);
    }

    @Test(dataProvider = "doubleBinaryOpProvider")
    static void subDoubleVector256TestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, DoubleVector256Tests::sub);
    }

    @Test(dataProvider = "doubleBinaryOpMaskProvider")
    static void subDoubleVector256TestsBroadcastMaskedSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, DoubleVector256Tests::sub);
    }

    @Test(dataProvider = "doubleBinaryOpProvider")
    static void mulDoubleVector256TestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, DoubleVector256Tests::mul);
    }

    @Test(dataProvider = "doubleBinaryOpMaskProvider")
    static void mulDoubleVector256TestsBroadcastMaskedSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, DoubleVector256Tests::mul);
    }

    @Test(dataProvider = "doubleBinaryOpProvider")
    static void divDoubleVector256TestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, DoubleVector256Tests::div);
    }

    @Test(dataProvider = "doubleBinaryOpMaskProvider")
    static void divDoubleVector256TestsBroadcastMaskedSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, DoubleVector256Tests::div);
    }

    @Test(dataProvider = "doubleBinaryOpProvider")
    static void ADDDoubleVector256TestsBroadcastLongSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastLongArraysEquals(r, a, b, DoubleVector256Tests::ADD);
    }

    @Test(dataProvider = "doubleBinaryOpMaskProvider")
    static void ADDDoubleVector256TestsBroadcastMaskedLongSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    static void MAXDoubleVector256TestsMaskedWithMemOp(IntFunction<double[]> fa, IntFunction<boolean[]> fm) {
        ...
        assertArraysEquals(r, a, (double)10, mask, DoubleVector256Tests::MAX);
    }
    ...
    @Test(dataProvider = "doubleBinaryOpProvider")
    static void MINDoubleVector256Tests(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, DoubleVector256Tests::MIN);
    }
    ...
    @Test(dataProvider = "doubleBinaryOpProvider")
    static void MAXDoubleVector256Tests(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, DoubleVector256Tests::MAX);
    }
    ...
    @Test(dataProvider = "doubleBinaryOpProvider")
    static void MINDoubleVector256TestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, DoubleVector256Tests::MIN);
    }
    ...
    @Test(dataProvider = "doubleBinaryOpProvider")
    static void MAXDoubleVector256TestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, DoubleVector256Tests::MAX);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void ADDReduceDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        double ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                DoubleVector256Tests::ADDReduce, DoubleVector256Tests::ADDReduceAll, RELATIVE_ROUNDING_ERROR_FACTOR_ADD);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpMaskProvider")
    static void ADDReduceDoubleVector256TestsMasked(IntFunction<double[]> fa, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Double> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                DoubleVector256Tests::ADDReduceMasked, DoubleVector256Tests::ADDReduceAllMasked, RELATIVE_ROUNDING_ERROR_FACTOR_ADD);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void MULReduceDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        double ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                DoubleVector256Tests::MULReduce, DoubleVector256Tests::MULReduceAll, RELATIVE_ROUNDING_ERROR_FACTOR_MUL);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpMaskProvider")
    static void MULReduceDoubleVector256TestsMasked(IntFunction<double[]> fa, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Double> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                DoubleVector256Tests::MULReduceMasked, DoubleVector256Tests::MULReduceAllMasked, RELATIVE_ROUNDING_ERROR_FACTOR_MUL);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void MINReduceDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        double ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                DoubleVector256Tests::MINReduce, DoubleVector256Tests::MINReduceAll);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpMaskProvider")
    static void MINReduceDoubleVector256TestsMasked(IntFunction<double[]> fa, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Double> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                DoubleVector256Tests::MINReduceMasked, DoubleVector256Tests::MINReduceAllMasked);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void MAXReduceDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        double ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                DoubleVector256Tests::MAXReduce, DoubleVector256Tests::MAXReduceAll);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpMaskProvider")
    static void MAXReduceDoubleVector256TestsMasked(IntFunction<double[]> fa, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Double> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                DoubleVector256Tests::MAXReduceMasked, DoubleVector256Tests::MAXReduceAllMasked);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void FIRST_NONZEROReduceDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        double ra = 0;
    ...
    @Test(dataProvider = "doubleUnaryOpMaskProvider")
    static void FIRST_NONZEROReduceDoubleVector256TestsMasked(IntFunction<double[]> fa, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Double> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                DoubleVector256Tests::FIRST_NONZEROReduceMasked, DoubleVector256Tests::FIRST_NONZEROReduceAllMasked);
    }

    @Test(dataProvider = "doubleBinaryOpProvider")
    static void withDoubleVector256Tests(IntFunction<double []> fa, IntFunction<double []> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    static void IS_DEFAULTDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
    ...
    static void IS_DEFAULTMaskedDoubleVector256Tests(IntFunction<double[]> fa,
                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Double> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    @Test(dataProvider = "doubleTestOpProvider")
    static void IS_NEGATIVEDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleTestOpMaskProvider")
    static void IS_NEGATIVEMaskedDoubleVector256Tests(IntFunction<double[]> fa,
                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Double> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    @Test(dataProvider = "doubleTestOpProvider")
    static void IS_FINITEDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleTestOpMaskProvider")
    static void IS_FINITEMaskedDoubleVector256Tests(IntFunction<double[]> fa,
                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Double> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    @Test(dataProvider = "doubleTestOpProvider")
    static void IS_NANDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleTestOpMaskProvider")
    static void IS_NANMaskedDoubleVector256Tests(IntFunction<double[]> fa,
                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Double> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    @Test(dataProvider = "doubleTestOpProvider")
    static void IS_INFINITEDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleTestOpMaskProvider")
    static void IS_INFINITEMaskedDoubleVector256Tests(IntFunction<double[]> fa,
                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Double> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    static void LTDoubleVector256Tests(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
    ...
    static void LTDoubleVector256TestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                                IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleCompareOpProvider")
    static void GTDoubleVector256Tests(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleCompareOpMaskProvider")
    static void GTDoubleVector256TestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                                IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleCompareOpProvider")
    static void EQDoubleVector256Tests(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleCompareOpMaskProvider")
    static void EQDoubleVector256TestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                                IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleCompareOpProvider")
    static void NEDoubleVector256Tests(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleCompareOpMaskProvider")
    static void NEDoubleVector256TestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                                IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleCompareOpProvider")
    static void LEDoubleVector256Tests(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleCompareOpMaskProvider")
    static void LEDoubleVector256TestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                                IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleCompareOpProvider")
    static void GEDoubleVector256Tests(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleCompareOpMaskProvider")
    static void GEDoubleVector256TestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                                IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleCompareOpProvider")
    static void LTDoubleVector256TestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleCompareOpMaskProvider")
    static void LTDoubleVector256TestsBroadcastMaskedSmokeTest(IntFunction<double[]> fa,
    ...
    @Test(dataProvider = "doubleCompareOpProvider")
    static void LTDoubleVector256TestsBroadcastLongSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleCompareOpMaskProvider")
    static void LTDoubleVector256TestsBroadcastLongMaskedSmokeTest(IntFunction<double[]> fa,
                                IntFunction<double[]> fb, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleCompareOpProvider")
    static void EQDoubleVector256TestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleCompareOpMaskProvider")
    static void EQDoubleVector256TestsBroadcastMaskedSmokeTest(IntFunction<double[]> fa,
                                IntFunction<double[]> fb, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleCompareOpProvider")
    static void EQDoubleVector256TestsBroadcastLongSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleCompareOpMaskProvider")
    static void EQDoubleVector256TestsBroadcastLongMaskedSmokeTest(IntFunction<double[]> fa,
                                IntFunction<double[]> fb, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleBinaryOpMaskProvider")
    static void blendDoubleVector256Tests(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, DoubleVector256Tests::blend);
    }

    @Test(dataProvider = "doubleUnaryOpShuffleProvider")
    static void RearrangeDoubleVector256Tests(IntFunction<double[]> fa,
    ...
    static void RearrangeDoubleVector256TestsMaskedSmokeTest(IntFunction<double[]> fa,
                                                          BiFunction<Integer,Integer,int[]> fs,
                                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        int[] order = fs.apply(a.length, SPECIES.length());
    ...
    @Test(dataProvider = "doubleUnaryOpMaskProvider")
    static void compressDoubleVector256Tests(IntFunction<double[]> fa,
                                                IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleUnaryOpMaskProvider")
    static void expandDoubleVector256Tests(IntFunction<double[]> fa,
                                                IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void getDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void BroadcastDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void ZeroDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = new double[a.length];
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void sliceUnaryDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = new double[a.length];
        ...
        assertArraysEquals(r, a, origin, DoubleVector256Tests::sliceUnary);
    }
    ...
    @Test(dataProvider = "doubleBinaryOpProvider")
    static void sliceBinaryDoubleVector256TestsBinary(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = new double[a.length];
        int origin = RAND.nextInt(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, DoubleVector256Tests::sliceBinary);
    }
    ...
    @Test(dataProvider = "doubleBinaryOpMaskProvider")
    static void sliceDoubleVector256TestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
    IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, mask, DoubleVector256Tests::slice);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void unsliceUnaryDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = new double[a.length];
        int origin = RAND.nextInt(SPECIES.length());
        for (int ic = 0; ic < INVOC_COUNT; ic++) {
        ...
        assertArraysEquals(r, a, origin, DoubleVector256Tests::unsliceUnary);
    }
    ...
    @Test(dataProvider = "doubleBinaryOpProvider")
    static void unsliceBinaryDoubleVector256TestsBinary(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = new double[a.length];
        int origin = RAND.nextInt(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, part, DoubleVector256Tests::unsliceBinary);
    }
    ...
    @Test(dataProvider = "doubleBinaryOpMaskProvider")
    static void unsliceDoubleVector256TestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
    IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, part, mask, DoubleVector256Tests::unslice);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void SINDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, DoubleVector256Tests::SIN, DoubleVector256Tests::strictSIN);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void EXPDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, DoubleVector256Tests::EXP, DoubleVector256Tests::strictEXP);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void LOG1PDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, DoubleVector256Tests::LOG1P, DoubleVector256Tests::strictLOG1P);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void LOGDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, DoubleVector256Tests::LOG, DoubleVector256Tests::strictLOG);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void LOG10DoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, DoubleVector256Tests::LOG10, DoubleVector256Tests::strictLOG10);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void EXPM1DoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, DoubleVector256Tests::EXPM1, DoubleVector256Tests::strictEXPM1);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void COSDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, DoubleVector256Tests::COS, DoubleVector256Tests::strictCOS);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void TANDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, DoubleVector256Tests::TAN, DoubleVector256Tests::strictTAN);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void SINHDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, DoubleVector256Tests::SINH, DoubleVector256Tests::strictSINH);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void COSHDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, DoubleVector256Tests::COSH, DoubleVector256Tests::strictCOSH);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void TANHDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, DoubleVector256Tests::TANH, DoubleVector256Tests::strictTANH);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void ASINDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, DoubleVector256Tests::ASIN, DoubleVector256Tests::strictASIN);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void ACOSDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, DoubleVector256Tests::ACOS, DoubleVector256Tests::strictACOS);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void ATANDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, DoubleVector256Tests::ATAN, DoubleVector256Tests::strictATAN);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void CBRTDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, DoubleVector256Tests::CBRT, DoubleVector256Tests::strictCBRT);
    }
    ...
    @Test(dataProvider = "doubleBinaryOpProvider")
    static void HYPOTDoubleVector256Tests(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, b, DoubleVector256Tests::HYPOT, DoubleVector256Tests::strictHYPOT);
    }
    ...
    @Test(dataProvider = "doubleBinaryOpProvider")
    static void POWDoubleVector256Tests(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, b, DoubleVector256Tests::POW, DoubleVector256Tests::strictPOW);
    }
    ...
    @Test(dataProvider = "doubleBinaryOpProvider")
    static void ATAN2DoubleVector256Tests(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEqualsWithinOneUlp(r, a, b, DoubleVector256Tests::ATAN2, DoubleVector256Tests::strictATAN2);
    }


    @Test(dataProvider = "doubleBinaryOpProvider")
    static void POWDoubleVector256TestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEqualsWithinOneUlp(r, a, b, DoubleVector256Tests::POW, DoubleVector256Tests::strictPOW);
    }
    ...
    static void FMADoubleVector256Tests(IntFunction<double[]> fa, IntFunction<double[]> fb, IntFunction<double[]> fc) {
        ...
        assertArraysEquals(r, a, b, c, DoubleVector256Tests::FMA);
    }
    ...
    static void FMADoubleVector256TestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
        ...
        assertArraysEquals(r, a, b, c, mask, DoubleVector256Tests::FMA);
    }

    @Test(dataProvider = "doubleTernaryOpProvider")
    static void FMADoubleVector256TestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb, IntFunction<double[]> fc) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] c = fc.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, c, DoubleVector256Tests::FMA);
    }

    @Test(dataProvider = "doubleTernaryOpProvider")
    static void FMADoubleVector256TestsAltBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb, IntFunction<double[]> fc) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] c = fc.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertAltBroadcastArraysEquals(r, a, b, c, DoubleVector256Tests::FMA);
    }

    @Test(dataProvider = "doubleTernaryOpMaskProvider")
    static void FMADoubleVector256TestsBroadcastMaskedSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                          IntFunction<double[]> fc, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] c = fc.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, c, mask, DoubleVector256Tests::FMA);
    }

    @Test(dataProvider = "doubleTernaryOpMaskProvider")
    static void FMADoubleVector256TestsAltBroadcastMaskedSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                          IntFunction<double[]> fc, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] c = fc.apply(SPECIES.length());
        ...
        assertAltBroadcastArraysEquals(r, a, b, c, mask, DoubleVector256Tests::FMA);
    }

    @Test(dataProvider = "doubleTernaryOpProvider")
    static void FMADoubleVector256TestsDoubleBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb, IntFunction<double[]> fc) {
        int count = INVOC_COUNT;
        switch ("FMA") {
        case "fma": case "lanewise_FMA":
           // Math.fma uses BigDecimal
        ...
        assertDoubleBroadcastArraysEquals(r, a, b, c, DoubleVector256Tests::FMA);
    }
    ...
    @Test(dataProvider = "doubleTernaryOpMaskProvider")
    static void FMADoubleVector256TestsDoubleBroadcastMaskedSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                          IntFunction<double[]> fc, IntFunction<boolean[]> fm) {
        int count = INVOC_COUNT;
        switch ("FMA") {
        case "fma": case "lanewise_FMA":
        ...
        assertDoubleBroadcastArraysEquals(r, a, b, c, mask, DoubleVector256Tests::FMA);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void NEGDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, DoubleVector256Tests::NEG);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpMaskProvider")
    static void NEGMaskedDoubleVector256Tests(IntFunction<double[]> fa,
                                                IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, DoubleVector256Tests::NEG);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void ABSDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, DoubleVector256Tests::ABS);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpMaskProvider")
    static void ABSMaskedDoubleVector256Tests(IntFunction<double[]> fa,
                                                IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, DoubleVector256Tests::ABS);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void SQRTDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, DoubleVector256Tests::SQRT);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpMaskProvider")
    static void SQRTMaskedDoubleVector256Tests(IntFunction<double[]> fa,
                                                IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, DoubleVector256Tests::SQRT);
    }
    ...
    static void maskandDoubleVector256Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        ...
        assertArraysEquals(r, a, b, DoubleVector256Tests::band);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskorDoubleVector256Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, DoubleVector256Tests::bor);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskxorDoubleVector256Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, DoubleVector256Tests::bxor);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskandNotDoubleVector256Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, DoubleVector256Tests::bandNot);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskeqDoubleVector256Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, DoubleVector256Tests::beq);
    }
    ...
    static void masknotDoubleVector256Tests(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, DoubleVector256Tests::unot);
    }
    ...
    static void maskFromToLongDoubleVector256Tests(IntFunction<long[]> fa) {
    ...
    @Test(dataProvider = "doubleCompareOpProvider")
    static void eqDoubleVector256TestsBroadcastMaskedSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
    ...
    static void toIntArrayDoubleVector256TestsSmokeTest(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
    ...
    static void toLongArrayDoubleVector256TestsSmokeTest(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void toStringDoubleVector256TestsSmokeTest(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void hashCodeDoubleVector256TestsSmokeTest(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void ADDReduceLongDoubleVector256Tests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        ...
        assertReductionLongArraysEquals(r, ra, a,
                DoubleVector256Tests::ADDReduceLong, DoubleVector256Tests::ADDReduceAllLong);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpMaskProvider")
    static void ADDReduceLongDoubleVector256TestsMasked(IntFunction<double[]> fa, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        long[] r = lfr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Double> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionLongArraysEqualsMasked(r, ra, a, mask,
                DoubleVector256Tests::ADDReduceLongMasked, DoubleVector256Tests::ADDReduceAllLongMasked);
    }

    @Test(dataProvider = "doubletoLongUnaryOpProvider")
    static void BroadcastLongDoubleVector256TestsSmokeTest(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = new double[a.length];
    ...
    @Test(dataProvider = "doubleBinaryOpMaskProvider")
    static void blendDoubleVector256TestsBroadcastLongSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastLongArraysEquals(r, a, b, mask, DoubleVector256Tests::blend);
    }


    @Test(dataProvider = "doubleUnaryOpSelectFromProvider")
    static void SelectFromDoubleVector256Tests(IntFunction<double[]> fa,
    ...
    static void SelectFromTwoVectorDoubleVector256Tests(IntFunction<double[]> fa, IntFunction<double[]> fb, IntFunction<double[]> fc) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
    ...
    static void SelectFromDoubleVector256TestsMaskedSmokeTest(IntFunction<double[]> fa,
                                                           BiFunction<Integer,Integer,double[]> fs,
                                                           IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] order = fs.apply(a.length, SPECIES.length());
    ...
    static void shuffleMiscellaneousDoubleVector256TestsSmokeTest(BiFunction<Integer,Integer,int[]> fs) {
    ...
    @Test(dataProvider = "shuffleProvider")
    static void shuffleToStringDoubleVector256TestsSmokeTest(BiFunction<Integer,Integer,int[]> fs) {
        int[] a = fs.apply(SPECIES.length() * BUFFER_REPS, SPECIES.length());
    ...
    static void shuffleEqualsDoubleVector256TestsSmokeTest(BiFunction<Integer,Integer,int[]> fa, BiFunction<Integer,Integer,int[]> fb) {
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskEqualsDoubleVector256Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
    ...
    static void maskHashCodeDoubleVector256TestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "maskProvider")
    static void maskTrueCountDoubleVector256TestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        ...
        assertMaskReductionArraysEquals(r, a, DoubleVector256Tests::maskTrueCount);
    }
    ...
    @Test(dataProvider = "maskProvider")
    static void maskLastTrueDoubleVector256TestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        int[] r = new int[a.length];
        ...
        assertMaskReductionArraysEquals(r, a, DoubleVector256Tests::maskLastTrue);
    }
    ...
    @Test(dataProvider = "maskProvider")
    static void maskFirstTrueDoubleVector256TestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        int[] r = new int[a.length];
        ...
        assertMaskReductionArraysEquals(r, a, DoubleVector256Tests::maskFirstTrue);
    }

    @Test(dataProvider = "maskProvider")
    static void maskCompressDoubleVector256TestsSmokeTest(IntFunction<boolean[]> fa) {
        int trueCount = 0;
        boolean[] a = fa.apply(SPECIES.length());
    ...
    static void indexInRangeDoubleVector256TestsSmokeTest(int offset) {
    ...
    @Test(dataProvider = "offsetProvider")
    static void indexInRangeLongDoubleVector256TestsSmokeTest(int offset) {
    ...
    static void loopBoundDoubleVector256TestsSmokeTest(int length) {
    ...
    @Test(dataProvider = "lengthProvider")
    static void loopBoundLongDoubleVector256TestsSmokeTest(int _length) {
        long length = _length;
    ...
    @Test
    static void ShapeWithLanesDoubleVector256TestsSmokeTest() {
        DoubleVector av = DoubleVector.zero(SPECIES);
        VectorShape vsh = av.shape();
    ...
    @Test
    static void ElementTypeDoubleVector256TestsSmokeTest() {
        DoubleVector av = DoubleVector.zero(SPECIES);
        assert(av.species().elementType() == double.class);
    }

    @Test
    static void SpeciesElementSizeDoubleVector256TestsSmokeTest() {
        DoubleVector av = DoubleVector.zero(SPECIES);
        assert(av.species().elementSize() == Double.SIZE);
    }

    @Test
    static void VectorTypeDoubleVector256TestsSmokeTest() {
        DoubleVector av = DoubleVector.zero(SPECIES);
        assert(av.species().vectorType() == av.getClass());
    }

    @Test
    static void WithLanesDoubleVector256TestsSmokeTest() {
        DoubleVector av = DoubleVector.zero(SPECIES);
    ...
    @Test
    static void WithShapeDoubleVector256TestsSmokeTest() {
        DoubleVector av = DoubleVector.zero(SPECIES);
        VectorShape vsh = av.shape();
    ...
    @Test
    static void MaskAllTrueDoubleVector256TestsSmokeTest() {
        for (int ic = 0; ic < INVOC_COUNT; ic++) {
