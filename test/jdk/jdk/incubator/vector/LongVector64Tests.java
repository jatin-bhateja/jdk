 ...
 * @run testng/othervm/timeout=300 -ea -esa -Xbatch -XX:-TieredCompilation LongVector64Tests
 */
...
@Test
public class LongVector64Tests extends AbstractVectorTest {
   ...
   public Object[][] longSaturatingUnaryOpMaskProvider() {
    ...
    static void ADDLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::ADD);
    }
    ...
    static void ADDLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
        ...
        assertArraysEquals(r, a, b, mask, LongVector64Tests::ADD);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void SUBLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::SUB);
    }
    ...
    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void SUBLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector64Tests::SUB);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void MULLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::MUL);
    }
    ...
    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void MULLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector64Tests::MUL);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void DIVLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::DIV);
    }
    ...
    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void DIVLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector64Tests::DIV);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void FIRST_NONZEROLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::FIRST_NONZERO);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void FIRST_NONZEROLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector64Tests::FIRST_NONZERO);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void ANDLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::AND);
    }
    ...
    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void ANDLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector64Tests::AND);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void AND_NOTLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::AND_NOT);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void AND_NOTLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector64Tests::AND_NOT);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void ORLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::OR);
    }
    ...
    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void ORLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector64Tests::OR);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void XORLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::XOR);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void XORLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector64Tests::XOR);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void COMPRESS_BITSLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::COMPRESS_BITS);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void COMPRESS_BITSLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector64Tests::COMPRESS_BITS);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void EXPAND_BITSLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::EXPAND_BITS);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void EXPAND_BITSLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector64Tests::EXPAND_BITS);
    }

    @Test(dataProvider = "longBinaryOpProvider")
    static void addLongVector64TestsBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, LongVector64Tests::add);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void addLongVector64TestsBroadcastMaskedSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, LongVector64Tests::add);
    }

    @Test(dataProvider = "longBinaryOpProvider")
    static void subLongVector64TestsBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, LongVector64Tests::sub);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void subLongVector64TestsBroadcastMaskedSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, LongVector64Tests::sub);
    }

    @Test(dataProvider = "longBinaryOpProvider")
    static void mulLongVector64TestsBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, LongVector64Tests::mul);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void mulLongVector64TestsBroadcastMaskedSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, LongVector64Tests::mul);
    }

    @Test(dataProvider = "longBinaryOpProvider")
    static void divLongVector64TestsBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, LongVector64Tests::div);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void divLongVector64TestsBroadcastMaskedSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, LongVector64Tests::div);
    }

    @Test(dataProvider = "longBinaryOpProvider")
    static void ORLongVector64TestsBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, LongVector64Tests::OR);
    }
    ...
    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void ORLongVector64TestsBroadcastMaskedSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, LongVector64Tests::OR);
    }

    @Test(dataProvider = "longBinaryOpProvider")
    static void ANDLongVector64TestsBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, LongVector64Tests::AND);
    }
    ...
    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void ANDLongVector64TestsBroadcastMaskedSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, LongVector64Tests::AND);
    }

    @Test(dataProvider = "longBinaryOpProvider")
    static void ORLongVector64TestsBroadcastLongSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastLongArraysEquals(r, a, b, LongVector64Tests::OR);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void ORLongVector64TestsBroadcastMaskedLongSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastLongArraysEquals(r, a, b, mask, LongVector64Tests::OR);
    }

    @Test(dataProvider = "longBinaryOpProvider")
    static void ADDLongVector64TestsBroadcastLongSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastLongArraysEquals(r, a, b, LongVector64Tests::ADD);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void ADDLongVector64TestsBroadcastMaskedLongSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastLongArraysEquals(r, a, b, mask, LongVector64Tests::ADD);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void LSHLLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::LSHL);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void LSHLLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector64Tests::LSHL);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void ASHRLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::ASHR);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void ASHRLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector64Tests::ASHR);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void LSHRLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::LSHR);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void LSHRLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector64Tests::LSHR);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void LSHLLongVector64TestsScalarShift(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, LongVector64Tests::LSHL_unary);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void LSHLLongVector64TestsScalarShiftMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, mask, LongVector64Tests::LSHL_unary);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void LSHRLongVector64TestsScalarShift(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, LongVector64Tests::LSHR_unary);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void LSHRLongVector64TestsScalarShiftMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, mask, LongVector64Tests::LSHR_unary);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void ASHRLongVector64TestsScalarShift(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, LongVector64Tests::ASHR_unary);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void ASHRLongVector64TestsScalarShiftMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, mask, LongVector64Tests::ASHR_unary);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void RORLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::ROR);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void RORLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector64Tests::ROR);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void ROLLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::ROL);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void ROLLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector64Tests::ROL);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void RORLongVector64TestsScalarShift(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, LongVector64Tests::ROR_unary);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void RORLongVector64TestsScalarShiftMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, mask, LongVector64Tests::ROR_unary);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void ROLLongVector64TestsScalarShift(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, LongVector64Tests::ROL_unary);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void ROLLongVector64TestsScalarShiftMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, mask, LongVector64Tests::ROL_unary);
    }
    ...
    static void LSHRLongVector64TestsScalarShiftConst(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, LongVector64Tests::LSHR_binary_const);
    }

    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void LSHRLongVector64TestsScalarShiftMaskedConst(IntFunction<long[]> fa,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, mask, LongVector64Tests::LSHR_binary_const);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void LSHLLongVector64TestsScalarShiftConst(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, LongVector64Tests::LSHL_binary_const);
    }

    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void LSHLLongVector64TestsScalarShiftMaskedConst(IntFunction<long[]> fa,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, mask, LongVector64Tests::LSHL_binary_const);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void ASHRLongVector64TestsScalarShiftConst(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, LongVector64Tests::ASHR_binary_const);
    }

    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void ASHRLongVector64TestsScalarShiftMaskedConst(IntFunction<long[]> fa,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, mask, LongVector64Tests::ASHR_binary_const);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void RORLongVector64TestsScalarShiftConst(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, LongVector64Tests::ROR_binary_const);
    }

    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void RORLongVector64TestsScalarShiftMaskedConst(IntFunction<long[]> fa,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, mask, LongVector64Tests::ROR_binary_const);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void ROLLongVector64TestsScalarShiftConst(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, LongVector64Tests::ROL_binary_const);
    }

    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void ROLLongVector64TestsScalarShiftMaskedConst(IntFunction<long[]> fa,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, mask, LongVector64Tests::ROL_binary_const);
    }
    ...
    static void MAXLongVector64TestsMaskedWithMemOp(IntFunction<long[]> fa, IntFunction<boolean[]> fm) {
        ...
        assertArraysEquals(r, a, (long)10, mask, LongVector64Tests::MAX);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void MINLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::MIN);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void MAXLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::MAX);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void UMINLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::UMIN);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void UMINLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector64Tests::UMIN);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void UMAXLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::UMAX);
    }

    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void UMAXLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector64Tests::UMAX);
    }
    ...
    static void SADDLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::SADD);
    }

    @Test(dataProvider = "longSaturatingBinaryOpMaskProvider")
    static void SADDLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector64Tests::SADD);
    }
    ...
    @Test(dataProvider = "longSaturatingBinaryOpProvider")
    static void SSUBLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::SSUB);
    }

    @Test(dataProvider = "longSaturatingBinaryOpMaskProvider")
    static void SSUBLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector64Tests::SSUB);
    }
    ...
    @Test(dataProvider = "longSaturatingBinaryOpProvider")
    static void SUADDLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::SUADD);
    }

    @Test(dataProvider = "longSaturatingBinaryOpMaskProvider")
    static void SUADDLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector64Tests::SUADD);
    }
    ...
    @Test(dataProvider = "longSaturatingBinaryOpProvider")
    static void SUSUBLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::SUSUB);
    }

    @Test(dataProvider = "longSaturatingBinaryOpMaskProvider")
    static void SUSUBLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector64Tests::SUSUB);
    }

    @Test(dataProvider = "longBinaryOpProvider")
    static void MINLongVector64TestsBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, LongVector64Tests::MIN);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void MAXLongVector64TestsBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, LongVector64Tests::MAX);
    }
    ...
    static void SUADDAssocLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb, IntFunction<long[]> fc) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        ...
        assertArraysEqualsAssociative(rl, rr, a, b, c, LongVector64Tests::SUADD);
    }

    @Test(dataProvider = "longSaturatingBinaryOpAssocMaskProvider")
    static void SUADDAssocLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
        ...
        assertArraysEqualsAssociative(rl, rr, a, b, c, mask, LongVector64Tests::SUADD);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void ANDReduceLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        long ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                LongVector64Tests::ANDReduce, LongVector64Tests::ANDReduceAll);
    }
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void ANDReduceLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                LongVector64Tests::ANDReduceMasked, LongVector64Tests::ANDReduceAllMasked);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void ORReduceLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        long ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                LongVector64Tests::ORReduce, LongVector64Tests::ORReduceAll);
    }
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void ORReduceLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                LongVector64Tests::ORReduceMasked, LongVector64Tests::ORReduceAllMasked);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void XORReduceLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        long ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                LongVector64Tests::XORReduce, LongVector64Tests::XORReduceAll);
    }
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void XORReduceLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                LongVector64Tests::XORReduceMasked, LongVector64Tests::XORReduceAllMasked);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void ADDReduceLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        long ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                LongVector64Tests::ADDReduce, LongVector64Tests::ADDReduceAll);
    }
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void ADDReduceLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                LongVector64Tests::ADDReduceMasked, LongVector64Tests::ADDReduceAllMasked);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void MULReduceLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        long ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                LongVector64Tests::MULReduce, LongVector64Tests::MULReduceAll);
    }
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void MULReduceLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                LongVector64Tests::MULReduceMasked, LongVector64Tests::MULReduceAllMasked);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void MINReduceLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        long ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                LongVector64Tests::MINReduce, LongVector64Tests::MINReduceAll);
    }
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void MINReduceLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                LongVector64Tests::MINReduceMasked, LongVector64Tests::MINReduceAllMasked);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void MAXReduceLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        long ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                LongVector64Tests::MAXReduce, LongVector64Tests::MAXReduceAll);
    }
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void MAXReduceLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                LongVector64Tests::MAXReduceMasked, LongVector64Tests::MAXReduceAllMasked);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void UMINReduceLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        long ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                LongVector64Tests::UMINReduce, LongVector64Tests::UMINReduceAll);
    }
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void UMINReduceLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                LongVector64Tests::UMINReduceMasked, LongVector64Tests::UMINReduceAllMasked);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void UMAXReduceLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        long ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                LongVector64Tests::UMAXReduce, LongVector64Tests::UMAXReduceAll);
    }
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void UMAXReduceLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                LongVector64Tests::UMAXReduceMasked, LongVector64Tests::UMAXReduceAllMasked);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void FIRST_NONZEROReduceLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        long ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                LongVector64Tests::FIRST_NONZEROReduce, LongVector64Tests::FIRST_NONZEROReduceAll);
    }
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void FIRST_NONZEROReduceLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                LongVector64Tests::FIRST_NONZEROReduceMasked, LongVector64Tests::FIRST_NONZEROReduceAllMasked);
    }
    ...
    static void anyTrueLongVector64Tests(IntFunction<boolean[]> fm) {
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertReductionBoolArraysEquals(r, mask, LongVector64Tests::anyTrue);
    }
    ...
    @Test(dataProvider = "boolUnaryOpProvider")
    static void allTrueLongVector64Tests(IntFunction<boolean[]> fm) {
        boolean[] mask = fm.apply(SPECIES.length());
        boolean[] r = fmr.apply(SPECIES.length());
        ...
        assertReductionBoolArraysEquals(r, mask, LongVector64Tests::allTrue);
    }
    ...
    static void SUADDReduceLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        long ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                LongVector64Tests::SUADDReduce, LongVector64Tests::SUADDReduceAll);
    }
    ...
    static void SUADDReduceLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                LongVector64Tests::SUADDReduceMasked, LongVector64Tests::SUADDReduceAllMasked);
    }

    @Test(dataProvider = "longBinaryOpProvider")
    static void withLongVector64Tests(IntFunction<long []> fa, IntFunction<long []> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
    ...
    static void IS_DEFAULTLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
    ...
    static void IS_DEFAULTMaskedLongVector64Tests(IntFunction<long[]> fa,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    @Test(dataProvider = "longTestOpProvider")
    static void IS_NEGATIVELongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longTestOpMaskProvider")
    static void IS_NEGATIVEMaskedLongVector64Tests(IntFunction<long[]> fa,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    static void LTLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    static void LTLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpProvider")
    static void GTLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpMaskProvider")
    static void GTLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpProvider")
    static void EQLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpMaskProvider")
    static void EQLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpProvider")
    static void NELongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpMaskProvider")
    static void NELongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpProvider")
    static void LELongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpMaskProvider")
    static void LELongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpProvider")
    static void GELongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpMaskProvider")
    static void GELongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpProvider")
    static void ULTLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpMaskProvider")
    static void ULTLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpProvider")
    static void UGTLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpMaskProvider")
    static void UGTLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpProvider")
    static void ULELongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpMaskProvider")
    static void ULELongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpProvider")
    static void UGELongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpMaskProvider")
    static void UGELongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpProvider")
    static void LTLongVector64TestsBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpMaskProvider")
    static void LTLongVector64TestsBroadcastMaskedSmokeTest(IntFunction<long[]> fa,
    ...
    @Test(dataProvider = "longCompareOpProvider")
    static void EQLongVector64TestsBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longCompareOpMaskProvider")
    static void EQLongVector64TestsBroadcastMaskedSmokeTest(IntFunction<long[]> fa,
                                IntFunction<long[]> fb, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void blendLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, LongVector64Tests::blend);
    }

    @Test(dataProvider = "longUnaryOpShuffleProvider")
    static void RearrangeLongVector64Tests(IntFunction<long[]> fa,
    ...
    static void RearrangeLongVector64TestsMaskedSmokeTest(IntFunction<long[]> fa,
                                                          BiFunction<Integer,Integer,int[]> fs,
                                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        int[] order = fs.apply(a.length, SPECIES.length());
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void compressLongVector64Tests(IntFunction<long[]> fa,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void expandLongVector64Tests(IntFunction<long[]> fa,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void intersectLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void getLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void BroadcastLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void ZeroLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = new long[a.length];
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void sliceUnaryLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = new long[a.length];
        ...
        assertArraysEquals(r, a, origin, LongVector64Tests::sliceUnary);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void sliceBinaryLongVector64TestsBinary(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = new long[a.length];
        int origin = RAND.nextInt(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, LongVector64Tests::sliceBinary);
    }
    ...
    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void sliceLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
    IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, mask, LongVector64Tests::slice);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void unsliceUnaryLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = new long[a.length];
        int origin = RAND.nextInt(SPECIES.length());
        for (int ic = 0; ic < INVOC_COUNT; ic++) {
        ...
        assertArraysEquals(r, a, origin, LongVector64Tests::unsliceUnary);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void unsliceBinaryLongVector64TestsBinary(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = new long[a.length];
        int origin = RAND.nextInt(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, part, LongVector64Tests::unsliceBinary);
    }
    ...
    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void unsliceLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
    IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, part, mask, LongVector64Tests::unslice);
    }
    ...
    static void BITWISE_BLENDLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb, IntFunction<long[]> fc) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] c = fc.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, c, LongVector64Tests::BITWISE_BLEND);
    }

    @Test(dataProvider = "longTernaryOpProvider")
    static void bitwiseBlendLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb, IntFunction<long[]> fc) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] c = fc.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, c, LongVector64Tests::bitwiseBlend);
    }

    @Test(dataProvider = "longTernaryOpMaskProvider")
    static void BITWISE_BLENDLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<long[]> fc, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] c = fc.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, c, mask, LongVector64Tests::BITWISE_BLEND);
    }

    @Test(dataProvider = "longTernaryOpProvider")
    static void BITWISE_BLENDLongVector64TestsBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb, IntFunction<long[]> fc) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] c = fc.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, c, LongVector64Tests::BITWISE_BLEND);
    }

    @Test(dataProvider = "longTernaryOpProvider")
    static void BITWISE_BLENDLongVector64TestsAltBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb, IntFunction<long[]> fc) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] c = fc.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertAltBroadcastArraysEquals(r, a, b, c, LongVector64Tests::BITWISE_BLEND);
    }

    @Test(dataProvider = "longTernaryOpProvider")
    static void bitwiseBlendLongVector64TestsBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb, IntFunction<long[]> fc) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] c = fc.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, c, LongVector64Tests::bitwiseBlend);
    }

    @Test(dataProvider = "longTernaryOpProvider")
    static void bitwiseBlendLongVector64TestsAltBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb, IntFunction<long[]> fc) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] c = fc.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertAltBroadcastArraysEquals(r, a, b, c, LongVector64Tests::bitwiseBlend);
    }

    @Test(dataProvider = "longTernaryOpMaskProvider")
    static void BITWISE_BLENDLongVector64TestsBroadcastMaskedSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<long[]> fc, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] c = fc.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, c, mask, LongVector64Tests::BITWISE_BLEND);
    }

    @Test(dataProvider = "longTernaryOpMaskProvider")
    static void BITWISE_BLENDLongVector64TestsAltBroadcastMaskedSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<long[]> fc, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] c = fc.apply(SPECIES.length());
        ...
        assertAltBroadcastArraysEquals(r, a, b, c, mask, LongVector64Tests::BITWISE_BLEND);
    }

    @Test(dataProvider = "longTernaryOpProvider")
    static void BITWISE_BLENDLongVector64TestsDoubleBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb, IntFunction<long[]> fc) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] c = fc.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertDoubleBroadcastArraysEquals(r, a, b, c, LongVector64Tests::BITWISE_BLEND);
    }

    @Test(dataProvider = "longTernaryOpProvider")
    static void bitwiseBlendLongVector64TestsDoubleBroadcastSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb, IntFunction<long[]> fc) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] c = fc.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertDoubleBroadcastArraysEquals(r, a, b, c, LongVector64Tests::bitwiseBlend);
    }

    @Test(dataProvider = "longTernaryOpMaskProvider")
    static void BITWISE_BLENDLongVector64TestsDoubleBroadcastMaskedSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<long[]> fc, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] c = fc.apply(SPECIES.length());
        ...
        assertDoubleBroadcastArraysEquals(r, a, b, c, mask, LongVector64Tests::BITWISE_BLEND);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void NEGLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, LongVector64Tests::NEG);
    }
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void NEGMaskedLongVector64Tests(IntFunction<long[]> fa,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, LongVector64Tests::NEG);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void ABSLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, LongVector64Tests::ABS);
    }
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void ABSMaskedLongVector64Tests(IntFunction<long[]> fa,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, LongVector64Tests::ABS);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void NOTLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, LongVector64Tests::NOT);
    }
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void NOTMaskedLongVector64Tests(IntFunction<long[]> fa,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, LongVector64Tests::NOT);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void ZOMOLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, LongVector64Tests::ZOMO);
    }

    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void ZOMOMaskedLongVector64Tests(IntFunction<long[]> fa,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, LongVector64Tests::ZOMO);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void BIT_COUNTLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, LongVector64Tests::BIT_COUNT);
    }

    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void BIT_COUNTMaskedLongVector64Tests(IntFunction<long[]> fa,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, LongVector64Tests::BIT_COUNT);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void TRAILING_ZEROS_COUNTLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, LongVector64Tests::TRAILING_ZEROS_COUNT);
    }

    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void TRAILING_ZEROS_COUNTMaskedLongVector64Tests(IntFunction<long[]> fa,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, LongVector64Tests::TRAILING_ZEROS_COUNT);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void LEADING_ZEROS_COUNTLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, LongVector64Tests::LEADING_ZEROS_COUNT);
    }

    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void LEADING_ZEROS_COUNTMaskedLongVector64Tests(IntFunction<long[]> fa,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, LongVector64Tests::LEADING_ZEROS_COUNT);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void REVERSELongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, LongVector64Tests::REVERSE);
    }

    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void REVERSEMaskedLongVector64Tests(IntFunction<long[]> fa,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, LongVector64Tests::REVERSE);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void REVERSE_BYTESLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, LongVector64Tests::REVERSE_BYTES);
    }

    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void REVERSE_BYTESMaskedLongVector64Tests(IntFunction<long[]> fa,
                                                IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, LongVector64Tests::REVERSE_BYTES);
    }
    ...
    static void maskandLongVector64Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::band);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskorLongVector64Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::bor);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskxorLongVector64Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::bxor);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskandNotLongVector64Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::bandNot);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskeqLongVector64Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, LongVector64Tests::beq);
    }
    ...
    static void masknotLongVector64Tests(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, LongVector64Tests::unot);
    }
    ...
    static void maskFromToLongLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = new long[a.length];
    ...
    @Test(dataProvider = "longCompareOpProvider")
    static void eqLongVector64TestsBroadcastMaskedSmokeTest(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    static void toIntArrayLongVector64TestsSmokeTest(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void toLongArrayLongVector64TestsSmokeTest(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void toDoubleArrayLongVector64TestsSmokeTest(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void toStringLongVector64TestsSmokeTest(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void hashCodeLongVector64TestsSmokeTest(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void ADDReduceLongLongVector64Tests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        long ra = 0;
    ...
    @Test(dataProvider = "longUnaryOpMaskProvider")
    static void ADDReduceLongLongVector64TestsMasked(IntFunction<long[]> fa, IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Long> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    static void SelectFromLongVector64Tests(IntFunction<long[]> fa,
    ...
    static void SelectFromTwoVectorLongVector64Tests(IntFunction<long[]> fa, IntFunction<long[]> fb, IntFunction<long[]> fc) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
    ...
    static void SelectFromLongVector64TestsMaskedSmokeTest(IntFunction<long[]> fa,
                                                           BiFunction<Integer,Integer,long[]> fs,
                                                           IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] order = fs.apply(a.length, SPECIES.length());
    ...
    static void shuffleMiscellaneousLongVector64TestsSmokeTest(BiFunction<Integer,Integer,int[]> fs) {
    ...
    @Test(dataProvider = "shuffleProvider")
    static void shuffleToStringLongVector64TestsSmokeTest(BiFunction<Integer,Integer,int[]> fs) {
        int[] a = fs.apply(SPECIES.length() * BUFFER_REPS, SPECIES.length());
    ...
    static void shuffleEqualsLongVector64TestsSmokeTest(BiFunction<Integer,Integer,int[]> fa, BiFunction<Integer,Integer,int[]> fb) {
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskEqualsLongVector64Tests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
    ...
    static void maskHashCodeLongVector64TestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "maskProvider")
    static void maskTrueCountLongVector64TestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        ...
        assertMaskReductionArraysEquals(r, a, LongVector64Tests::maskTrueCount);
    }
    ...
    @Test(dataProvider = "maskProvider")
    static void maskLastTrueLongVector64TestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        int[] r = new int[a.length];
        ...
        assertMaskReductionArraysEquals(r, a, LongVector64Tests::maskLastTrue);
    }
    ...
    @Test(dataProvider = "maskProvider")
    static void maskFirstTrueLongVector64TestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        int[] r = new int[a.length];
        ...
        assertMaskReductionArraysEquals(r, a, LongVector64Tests::maskFirstTrue);
    }

    @Test(dataProvider = "maskProvider")
    static void maskCompressLongVector64TestsSmokeTest(IntFunction<boolean[]> fa) {
        int trueCount = 0;
        boolean[] a = fa.apply(SPECIES.length());
    ...
    static void indexInRangeLongVector64TestsSmokeTest(int offset) {
    ...
    @Test(dataProvider = "offsetProvider")
    static void indexInRangeLongLongVector64TestsSmokeTest(int offset) {
    ...
    static void loopBoundLongVector64TestsSmokeTest(int length) {
    ...
    @Test(dataProvider = "lengthProvider")
    static void loopBoundLongLongVector64TestsSmokeTest(int _length) {
        long length = _length;
    ...
    @Test
    static void ElementSizeLongVector64TestsSmokeTest() {
    ...
    @Test
    static void ShapeWithLanesLongVector64TestsSmokeTest() {
        LongVector av = LongVector.zero(SPECIES);
        VectorShape vsh = av.shape();
    ...
    @Test
    static void ElementTypeLongVector64TestsSmokeTest() {
        LongVector av = LongVector.zero(SPECIES);
    ...
    @Test
    static void VectorTypeLongVector64TestsSmokeTest() {
        LongVector av = LongVector.zero(SPECIES);
        assert(av.species().vectorType() == av.getClass());
    }

    @Test
    static void WithLanesLongVector64TestsSmokeTest() {
        LongVector av = LongVector.zero(SPECIES);
    ...
    @Test
    static void WithShapeLongVector64TestsSmokeTest() {
        LongVector av = LongVector.zero(SPECIES);
        VectorShape vsh = av.shape();
    ...
    @Test
    static void MaskAllTrueLongVector64TestsSmokeTest() {
        for (int ic = 0; ic < INVOC_COUNT; ic++) {
