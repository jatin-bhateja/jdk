 ...
 * @run testng/othervm/timeout=300 -ea -esa -Xbatch -XX:-TieredCompilation ShortVectorMaxTests
 */
...
@Test
public class ShortVectorMaxTests extends AbstractVectorTest {
   ...
   public Object[][] shortSaturatingUnaryOpMaskProvider() {
    ...
    static void ADDShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::ADD);
    }
    ...
    static void ADDShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
        ...
        assertArraysEquals(r, a, b, mask, ShortVectorMaxTests::ADD);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void SUBShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::SUB);
    }
    ...
    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void SUBShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ShortVectorMaxTests::SUB);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void MULShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::MUL);
    }
    ...
    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void MULShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ShortVectorMaxTests::MUL);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void DIVShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::DIV);
    }
    ...
    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void DIVShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ShortVectorMaxTests::DIV);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void FIRST_NONZEROShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::FIRST_NONZERO);
    }

    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void FIRST_NONZEROShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ShortVectorMaxTests::FIRST_NONZERO);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void ANDShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::AND);
    }
    ...
    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void ANDShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ShortVectorMaxTests::AND);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void AND_NOTShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::AND_NOT);
    }

    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void AND_NOTShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ShortVectorMaxTests::AND_NOT);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void ORShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::OR);
    }
    ...
    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void ORShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ShortVectorMaxTests::OR);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void XORShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::XOR);
    }

    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void XORShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ShortVectorMaxTests::XOR);
    }

    @Test(dataProvider = "shortBinaryOpProvider")
    static void addShortVectorMaxTestsBroadcastSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, ShortVectorMaxTests::add);
    }

    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void addShortVectorMaxTestsBroadcastMaskedSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, ShortVectorMaxTests::add);
    }

    @Test(dataProvider = "shortBinaryOpProvider")
    static void subShortVectorMaxTestsBroadcastSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, ShortVectorMaxTests::sub);
    }

    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void subShortVectorMaxTestsBroadcastMaskedSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, ShortVectorMaxTests::sub);
    }

    @Test(dataProvider = "shortBinaryOpProvider")
    static void mulShortVectorMaxTestsBroadcastSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, ShortVectorMaxTests::mul);
    }

    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void mulShortVectorMaxTestsBroadcastMaskedSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, ShortVectorMaxTests::mul);
    }

    @Test(dataProvider = "shortBinaryOpProvider")
    static void divShortVectorMaxTestsBroadcastSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, ShortVectorMaxTests::div);
    }

    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void divShortVectorMaxTestsBroadcastMaskedSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, ShortVectorMaxTests::div);
    }

    @Test(dataProvider = "shortBinaryOpProvider")
    static void ORShortVectorMaxTestsBroadcastSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, ShortVectorMaxTests::OR);
    }
    ...
    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void ORShortVectorMaxTestsBroadcastMaskedSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, ShortVectorMaxTests::OR);
    }

    @Test(dataProvider = "shortBinaryOpProvider")
    static void ANDShortVectorMaxTestsBroadcastSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, ShortVectorMaxTests::AND);
    }
    ...
    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void ANDShortVectorMaxTestsBroadcastMaskedSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, ShortVectorMaxTests::AND);
    }

    @Test(dataProvider = "shortBinaryOpProvider")
    static void ORShortVectorMaxTestsBroadcastLongSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastLongArraysEquals(r, a, b, ShortVectorMaxTests::OR);
    }

    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void ORShortVectorMaxTestsBroadcastMaskedLongSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastLongArraysEquals(r, a, b, mask, ShortVectorMaxTests::OR);
    }

    @Test(dataProvider = "shortBinaryOpProvider")
    static void ADDShortVectorMaxTestsBroadcastLongSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastLongArraysEquals(r, a, b, ShortVectorMaxTests::ADD);
    }

    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void ADDShortVectorMaxTestsBroadcastMaskedLongSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastLongArraysEquals(r, a, b, mask, ShortVectorMaxTests::ADD);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void LSHLShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::LSHL);
    }

    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void LSHLShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ShortVectorMaxTests::LSHL);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void ASHRShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::ASHR);
    }

    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void ASHRShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ShortVectorMaxTests::ASHR);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void LSHRShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::LSHR);
    }

    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void LSHRShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ShortVectorMaxTests::LSHR);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void LSHLShortVectorMaxTestsScalarShift(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, ShortVectorMaxTests::LSHL_unary);
    }

    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void LSHLShortVectorMaxTestsScalarShiftMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, mask, ShortVectorMaxTests::LSHL_unary);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void LSHRShortVectorMaxTestsScalarShift(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, ShortVectorMaxTests::LSHR_unary);
    }

    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void LSHRShortVectorMaxTestsScalarShiftMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, mask, ShortVectorMaxTests::LSHR_unary);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void ASHRShortVectorMaxTestsScalarShift(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, ShortVectorMaxTests::ASHR_unary);
    }

    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void ASHRShortVectorMaxTestsScalarShiftMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, mask, ShortVectorMaxTests::ASHR_unary);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void RORShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::ROR);
    }

    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void RORShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ShortVectorMaxTests::ROR);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void ROLShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::ROL);
    }

    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void ROLShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ShortVectorMaxTests::ROL);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void RORShortVectorMaxTestsScalarShift(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, ShortVectorMaxTests::ROR_unary);
    }

    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void RORShortVectorMaxTestsScalarShiftMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, mask, ShortVectorMaxTests::ROR_unary);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void ROLShortVectorMaxTestsScalarShift(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, ShortVectorMaxTests::ROL_unary);
    }

    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void ROLShortVectorMaxTestsScalarShiftMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(r, a, b, mask, ShortVectorMaxTests::ROL_unary);
    }
    ...
    static void LSHRShortVectorMaxTestsScalarShiftConst(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, ShortVectorMaxTests::LSHR_binary_const);
    }

    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void LSHRShortVectorMaxTestsScalarShiftMaskedConst(IntFunction<short[]> fa,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, mask, ShortVectorMaxTests::LSHR_binary_const);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void LSHLShortVectorMaxTestsScalarShiftConst(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, ShortVectorMaxTests::LSHL_binary_const);
    }

    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void LSHLShortVectorMaxTestsScalarShiftMaskedConst(IntFunction<short[]> fa,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, mask, ShortVectorMaxTests::LSHL_binary_const);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void ASHRShortVectorMaxTestsScalarShiftConst(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void ASHRShortVectorMaxTestsScalarShiftMaskedConst(IntFunction<short[]> fa,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void RORShortVectorMaxTestsScalarShiftConst(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, ShortVectorMaxTests::ROR_binary_const);
    }

    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void RORShortVectorMaxTestsScalarShiftMaskedConst(IntFunction<short[]> fa,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, mask, ShortVectorMaxTests::ROR_binary_const);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void ROLShortVectorMaxTestsScalarShiftConst(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, ShortVectorMaxTests::ROL_binary_const);
    }

    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void ROLShortVectorMaxTestsScalarShiftMaskedConst(IntFunction<short[]> fa,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertShiftConstEquals(r, a, mask, ShortVectorMaxTests::ROL_binary_const);
    }
    ...
    static void MAXShortVectorMaxTestsMaskedWithMemOp(IntFunction<short[]> fa, IntFunction<boolean[]> fm) {
        ...
        assertArraysEquals(r, a, (short)10, mask, ShortVectorMaxTests::MAX);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void MINShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::MIN);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void MAXShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::MAX);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void UMINShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::UMIN);
    }

    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void UMINShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ShortVectorMaxTests::UMIN);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void UMAXShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::UMAX);
    }

    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void UMAXShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ShortVectorMaxTests::UMAX);
    }
    ...
    static void SADDShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::SADD);
    }

    @Test(dataProvider = "shortSaturatingBinaryOpMaskProvider")
    static void SADDShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ShortVectorMaxTests::SADD);
    }
    ...
    @Test(dataProvider = "shortSaturatingBinaryOpProvider")
    static void SSUBShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::SSUB);
    }

    @Test(dataProvider = "shortSaturatingBinaryOpMaskProvider")
    static void SSUBShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ShortVectorMaxTests::SSUB);
    }
    ...
    @Test(dataProvider = "shortSaturatingBinaryOpProvider")
    static void SUADDShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::SUADD);
    }

    @Test(dataProvider = "shortSaturatingBinaryOpMaskProvider")
    static void SUADDShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ShortVectorMaxTests::SUADD);
    }
    ...
    @Test(dataProvider = "shortSaturatingBinaryOpProvider")
    static void SUSUBShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::SUSUB);
    }

    @Test(dataProvider = "shortSaturatingBinaryOpMaskProvider")
    static void SUSUBShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ShortVectorMaxTests::SUSUB);
    }

    @Test(dataProvider = "shortBinaryOpProvider")
    static void MINShortVectorMaxTestsBroadcastSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, ShortVectorMaxTests::MIN);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void MAXShortVectorMaxTestsBroadcastSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, ShortVectorMaxTests::MAX);
    }
    ...
    static void SUADDAssocShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb, IntFunction<short[]> fc) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        ...
        assertArraysEqualsAssociative(rl, rr, a, b, c, ShortVectorMaxTests::SUADD);
    }

    @Test(dataProvider = "shortSaturatingBinaryOpAssocMaskProvider")
    static void SUADDAssocShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
        ...
        assertArraysEqualsAssociative(rl, rr, a, b, c, mask, ShortVectorMaxTests::SUADD);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void ANDReduceShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        short ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                ShortVectorMaxTests::ANDReduce, ShortVectorMaxTests::ANDReduceAll);
    }
    ...
    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void ANDReduceShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Short> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                ShortVectorMaxTests::ANDReduceMasked, ShortVectorMaxTests::ANDReduceAllMasked);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void ORReduceShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        short ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                ShortVectorMaxTests::ORReduce, ShortVectorMaxTests::ORReduceAll);
    }
    ...
    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void ORReduceShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Short> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                ShortVectorMaxTests::ORReduceMasked, ShortVectorMaxTests::ORReduceAllMasked);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void XORReduceShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        short ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                ShortVectorMaxTests::XORReduce, ShortVectorMaxTests::XORReduceAll);
    }
    ...
    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void XORReduceShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Short> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                ShortVectorMaxTests::XORReduceMasked, ShortVectorMaxTests::XORReduceAllMasked);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void ADDReduceShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        short ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                ShortVectorMaxTests::ADDReduce, ShortVectorMaxTests::ADDReduceAll);
    }
    ...
    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void ADDReduceShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Short> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                ShortVectorMaxTests::ADDReduceMasked, ShortVectorMaxTests::ADDReduceAllMasked);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void MULReduceShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        short ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                ShortVectorMaxTests::MULReduce, ShortVectorMaxTests::MULReduceAll);
    }
    ...
    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void MULReduceShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Short> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                ShortVectorMaxTests::MULReduceMasked, ShortVectorMaxTests::MULReduceAllMasked);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void MINReduceShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        short ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                ShortVectorMaxTests::MINReduce, ShortVectorMaxTests::MINReduceAll);
    }
    ...
    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void MINReduceShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Short> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                ShortVectorMaxTests::MINReduceMasked, ShortVectorMaxTests::MINReduceAllMasked);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void MAXReduceShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        short ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                ShortVectorMaxTests::MAXReduce, ShortVectorMaxTests::MAXReduceAll);
    }
    ...
    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void MAXReduceShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Short> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                ShortVectorMaxTests::MAXReduceMasked, ShortVectorMaxTests::MAXReduceAllMasked);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void UMINReduceShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        short ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                ShortVectorMaxTests::UMINReduce, ShortVectorMaxTests::UMINReduceAll);
    }
    ...
    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void UMINReduceShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Short> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                ShortVectorMaxTests::UMINReduceMasked, ShortVectorMaxTests::UMINReduceAllMasked);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void UMAXReduceShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        short ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                ShortVectorMaxTests::UMAXReduce, ShortVectorMaxTests::UMAXReduceAll);
    }
    ...
    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void UMAXReduceShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Short> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                ShortVectorMaxTests::UMAXReduceMasked, ShortVectorMaxTests::UMAXReduceAllMasked);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void FIRST_NONZEROReduceShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        short ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                ShortVectorMaxTests::FIRST_NONZEROReduce, ShortVectorMaxTests::FIRST_NONZEROReduceAll);
    }
    ...
    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void FIRST_NONZEROReduceShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Short> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                ShortVectorMaxTests::FIRST_NONZEROReduceMasked, ShortVectorMaxTests::FIRST_NONZEROReduceAllMasked);
    }
    ...
    static void anyTrueShortVectorMaxTests(IntFunction<boolean[]> fm) {
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertReductionBoolArraysEquals(r, mask, ShortVectorMaxTests::anyTrue);
    }
    ...
    @Test(dataProvider = "boolUnaryOpProvider")
    static void allTrueShortVectorMaxTests(IntFunction<boolean[]> fm) {
        boolean[] mask = fm.apply(SPECIES.length());
        boolean[] r = fmr.apply(SPECIES.length());
        ...
        assertReductionBoolArraysEquals(r, mask, ShortVectorMaxTests::allTrue);
    }
    ...
    static void SUADDReduceShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        short ra = 0;
        ...
        assertReductionArraysEquals(r, ra, a,
                ShortVectorMaxTests::SUADDReduce, ShortVectorMaxTests::SUADDReduceAll);
    }
    ...
    static void SUADDReduceShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Short> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(r, ra, a, mask,
                ShortVectorMaxTests::SUADDReduceMasked, ShortVectorMaxTests::SUADDReduceAllMasked);
    }

    @Test(dataProvider = "shortBinaryOpProvider")
    static void withShortVectorMaxTests(IntFunction<short []> fa, IntFunction<short []> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
    ...
    static void IS_DEFAULTShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
    ...
    static void IS_DEFAULTMaskedShortVectorMaxTests(IntFunction<short[]> fa,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Short> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    @Test(dataProvider = "shortTestOpProvider")
    static void IS_NEGATIVEShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortTestOpMaskProvider")
    static void IS_NEGATIVEMaskedShortVectorMaxTests(IntFunction<short[]> fa,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Short> vmask = VectorMask.fromArray(SPECIES, mask, 0);
    ...
    static void LTShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
    ...
    static void LTShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                                IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpProvider")
    static void GTShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpMaskProvider")
    static void GTShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                                IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpProvider")
    static void EQShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpMaskProvider")
    static void EQShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                                IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpProvider")
    static void NEShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpMaskProvider")
    static void NEShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                                IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpProvider")
    static void LEShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpMaskProvider")
    static void LEShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                                IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpProvider")
    static void GEShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpMaskProvider")
    static void GEShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                                IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpProvider")
    static void ULTShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpMaskProvider")
    static void ULTShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                                IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpProvider")
    static void UGTShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpMaskProvider")
    static void UGTShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                                IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpProvider")
    static void ULEShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpMaskProvider")
    static void ULEShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                                IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpProvider")
    static void UGEShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpMaskProvider")
    static void UGEShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                                IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpProvider")
    static void LTShortVectorMaxTestsBroadcastSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpMaskProvider")
    static void LTShortVectorMaxTestsBroadcastMaskedSmokeTest(IntFunction<short[]> fa,
    ...
    @Test(dataProvider = "shortCompareOpProvider")
    static void LTShortVectorMaxTestsBroadcastLongSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpMaskProvider")
    static void LTShortVectorMaxTestsBroadcastLongMaskedSmokeTest(IntFunction<short[]> fa,
                                IntFunction<short[]> fb, IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpProvider")
    static void EQShortVectorMaxTestsBroadcastSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpMaskProvider")
    static void EQShortVectorMaxTestsBroadcastMaskedSmokeTest(IntFunction<short[]> fa,
                                IntFunction<short[]> fb, IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpProvider")
    static void EQShortVectorMaxTestsBroadcastLongSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpMaskProvider")
    static void EQShortVectorMaxTestsBroadcastLongMaskedSmokeTest(IntFunction<short[]> fa,
                                IntFunction<short[]> fb, IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void blendShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, ShortVectorMaxTests::blend);
    }

    @Test(dataProvider = "shortUnaryOpShuffleProvider")
    static void RearrangeShortVectorMaxTests(IntFunction<short[]> fa,
    ...
    static void RearrangeShortVectorMaxTestsMaskedSmokeTest(IntFunction<short[]> fa,
                                                          BiFunction<Integer,Integer,int[]> fs,
                                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        int[] order = fs.apply(a.length, SPECIES.length());
    ...
    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void compressShortVectorMaxTests(IntFunction<short[]> fa,
                                                IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void expandShortVectorMaxTests(IntFunction<short[]> fa,
                                                IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void intersectShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void getShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void BroadcastShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void ZeroShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = new short[a.length];
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void sliceUnaryShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = new short[a.length];
        ...
        assertArraysEquals(r, a, origin, ShortVectorMaxTests::sliceUnary);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void sliceBinaryShortVectorMaxTestsBinary(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = new short[a.length];
        int origin = RAND.nextInt(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, ShortVectorMaxTests::sliceBinary);
    }
    ...
    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void sliceShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
    IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, mask, ShortVectorMaxTests::slice);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void unsliceUnaryShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = new short[a.length];
        int origin = RAND.nextInt(SPECIES.length());
        for (int ic = 0; ic < INVOC_COUNT; ic++) {
        ...
        assertArraysEquals(r, a, origin, ShortVectorMaxTests::unsliceUnary);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void unsliceBinaryShortVectorMaxTestsBinary(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = new short[a.length];
        int origin = RAND.nextInt(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, part, ShortVectorMaxTests::unsliceBinary);
    }
    ...
    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void unsliceShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
    IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, part, mask, ShortVectorMaxTests::unslice);
    }
    ...
    static void BITWISE_BLENDShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb, IntFunction<short[]> fc) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] c = fc.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, c, ShortVectorMaxTests::BITWISE_BLEND);
    }

    @Test(dataProvider = "shortTernaryOpProvider")
    static void bitwiseBlendShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb, IntFunction<short[]> fc) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] c = fc.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, c, ShortVectorMaxTests::bitwiseBlend);
    }

    @Test(dataProvider = "shortTernaryOpMaskProvider")
    static void BITWISE_BLENDShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<short[]> fc, IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] c = fc.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, c, mask, ShortVectorMaxTests::BITWISE_BLEND);
    }

    @Test(dataProvider = "shortTernaryOpProvider")
    static void BITWISE_BLENDShortVectorMaxTestsBroadcastSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb, IntFunction<short[]> fc) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] c = fc.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, c, ShortVectorMaxTests::BITWISE_BLEND);
    }

    @Test(dataProvider = "shortTernaryOpProvider")
    static void BITWISE_BLENDShortVectorMaxTestsAltBroadcastSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb, IntFunction<short[]> fc) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] c = fc.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertAltBroadcastArraysEquals(r, a, b, c, ShortVectorMaxTests::BITWISE_BLEND);
    }

    @Test(dataProvider = "shortTernaryOpProvider")
    static void bitwiseBlendShortVectorMaxTestsBroadcastSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb, IntFunction<short[]> fc) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] c = fc.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, c, ShortVectorMaxTests::bitwiseBlend);
    }

    @Test(dataProvider = "shortTernaryOpProvider")
    static void bitwiseBlendShortVectorMaxTestsAltBroadcastSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb, IntFunction<short[]> fc) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] c = fc.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertAltBroadcastArraysEquals(r, a, b, c, ShortVectorMaxTests::bitwiseBlend);
    }

    @Test(dataProvider = "shortTernaryOpMaskProvider")
    static void BITWISE_BLENDShortVectorMaxTestsBroadcastMaskedSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<short[]> fc, IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] c = fc.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, c, mask, ShortVectorMaxTests::BITWISE_BLEND);
    }

    @Test(dataProvider = "shortTernaryOpMaskProvider")
    static void BITWISE_BLENDShortVectorMaxTestsAltBroadcastMaskedSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<short[]> fc, IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] c = fc.apply(SPECIES.length());
        ...
        assertAltBroadcastArraysEquals(r, a, b, c, mask, ShortVectorMaxTests::BITWISE_BLEND);
    }

    @Test(dataProvider = "shortTernaryOpProvider")
    static void BITWISE_BLENDShortVectorMaxTestsDoubleBroadcastSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb, IntFunction<short[]> fc) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] c = fc.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertDoubleBroadcastArraysEquals(r, a, b, c, ShortVectorMaxTests::BITWISE_BLEND);
    }

    @Test(dataProvider = "shortTernaryOpProvider")
    static void bitwiseBlendShortVectorMaxTestsDoubleBroadcastSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb, IntFunction<short[]> fc) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] c = fc.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertDoubleBroadcastArraysEquals(r, a, b, c, ShortVectorMaxTests::bitwiseBlend);
    }

    @Test(dataProvider = "shortTernaryOpMaskProvider")
    static void BITWISE_BLENDShortVectorMaxTestsDoubleBroadcastMaskedSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<short[]> fc, IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] c = fc.apply(SPECIES.length());
        ...
        assertDoubleBroadcastArraysEquals(r, a, b, c, mask, ShortVectorMaxTests::BITWISE_BLEND);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void NEGShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, ShortVectorMaxTests::NEG);
    }
    ...
    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void NEGMaskedShortVectorMaxTests(IntFunction<short[]> fa,
                                                IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, ShortVectorMaxTests::NEG);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void ABSShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, ShortVectorMaxTests::ABS);
    }
    ...
    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void ABSMaskedShortVectorMaxTests(IntFunction<short[]> fa,
                                                IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, ShortVectorMaxTests::ABS);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void NOTShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, ShortVectorMaxTests::NOT);
    }
    ...
    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void NOTMaskedShortVectorMaxTests(IntFunction<short[]> fa,
                                                IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, ShortVectorMaxTests::NOT);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void ZOMOShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, ShortVectorMaxTests::ZOMO);
    }

    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void ZOMOMaskedShortVectorMaxTests(IntFunction<short[]> fa,
                                                IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, ShortVectorMaxTests::ZOMO);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void BIT_COUNTShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, ShortVectorMaxTests::BIT_COUNT);
    }

    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void BIT_COUNTMaskedShortVectorMaxTests(IntFunction<short[]> fa,
                                                IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, ShortVectorMaxTests::BIT_COUNT);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void TRAILING_ZEROS_COUNTShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, ShortVectorMaxTests::TRAILING_ZEROS_COUNT);
    }

    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void TRAILING_ZEROS_COUNTMaskedShortVectorMaxTests(IntFunction<short[]> fa,
                                                IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, ShortVectorMaxTests::TRAILING_ZEROS_COUNT);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void LEADING_ZEROS_COUNTShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, ShortVectorMaxTests::LEADING_ZEROS_COUNT);
    }

    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void LEADING_ZEROS_COUNTMaskedShortVectorMaxTests(IntFunction<short[]> fa,
                                                IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, ShortVectorMaxTests::LEADING_ZEROS_COUNT);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void REVERSEShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, ShortVectorMaxTests::REVERSE);
    }

    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void REVERSEMaskedShortVectorMaxTests(IntFunction<short[]> fa,
                                                IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, ShortVectorMaxTests::REVERSE);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void REVERSE_BYTESShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, ShortVectorMaxTests::REVERSE_BYTES);
    }

    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void REVERSE_BYTESMaskedShortVectorMaxTests(IntFunction<short[]> fa,
                                                IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, ShortVectorMaxTests::REVERSE_BYTES);
    }
    ...
    static void maskandShortVectorMaxTests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::band);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskorShortVectorMaxTests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::bor);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskxorShortVectorMaxTests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::bxor);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskandNotShortVectorMaxTests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::bandNot);
    }
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskeqShortVectorMaxTests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, b, ShortVectorMaxTests::beq);
    }
    ...
    static void masknotShortVectorMaxTests(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] r = new boolean[a.length];
        ...
        assertArraysEquals(r, a, ShortVectorMaxTests::unot);
    }
    ...
    static void maskFromToLongShortVectorMaxTests(IntFunction<long[]> fa) {
    ...
    @Test(dataProvider = "shortCompareOpProvider")
    static void eqShortVectorMaxTestsBroadcastMaskedSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void toIntArrayShortVectorMaxTestsSmokeTest(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void toLongArrayShortVectorMaxTestsSmokeTest(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void toDoubleArrayShortVectorMaxTestsSmokeTest(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void toStringShortVectorMaxTestsSmokeTest(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void hashCodeShortVectorMaxTestsSmokeTest(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void ADDReduceLongShortVectorMaxTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        ...
        assertReductionLongArraysEquals(r, ra, a,
                ShortVectorMaxTests::ADDReduceLong, ShortVectorMaxTests::ADDReduceAllLong);
    }
    ...
    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void ADDReduceLongShortVectorMaxTestsMasked(IntFunction<short[]> fa, IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        long[] r = lfr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Short> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionLongArraysEqualsMasked(r, ra, a, mask,
                ShortVectorMaxTests::ADDReduceLongMasked, ShortVectorMaxTests::ADDReduceAllLongMasked);
    }

    @Test(dataProvider = "shortUnaryOpProvider")
    static void BroadcastLongShortVectorMaxTestsSmokeTest(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = new short[a.length];
    ...
    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void blendShortVectorMaxTestsBroadcastLongSmokeTest(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastLongArraysEquals(r, a, b, mask, ShortVectorMaxTests::blend);
    }


    @Test(dataProvider = "shortUnaryOpSelectFromProvider")
    static void SelectFromShortVectorMaxTests(IntFunction<short[]> fa,
    ...
    static void SelectFromTwoVectorShortVectorMaxTests(IntFunction<short[]> fa, IntFunction<short[]> fb, IntFunction<short[]> fc) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
    ...
    static void SelectFromShortVectorMaxTestsMaskedSmokeTest(IntFunction<short[]> fa,
                                                           BiFunction<Integer,Integer,short[]> fs,
                                                           IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] order = fs.apply(a.length, SPECIES.length());
    ...
    static void shuffleMiscellaneousShortVectorMaxTestsSmokeTest(BiFunction<Integer,Integer,int[]> fs) {
    ...
    @Test(dataProvider = "shuffleProvider")
    static void shuffleToStringShortVectorMaxTestsSmokeTest(BiFunction<Integer,Integer,int[]> fs) {
        int[] a = fs.apply(SPECIES.length() * BUFFER_REPS, SPECIES.length());
    ...
    static void shuffleEqualsShortVectorMaxTestsSmokeTest(BiFunction<Integer,Integer,int[]> fa, BiFunction<Integer,Integer,int[]> fb) {
    ...
    @Test(dataProvider = "boolMaskBinaryOpProvider")
    static void maskEqualsShortVectorMaxTests(IntFunction<boolean[]> fa, IntFunction<boolean[]> fb) {
        boolean[] a = fa.apply(SPECIES.length());
        boolean[] b = fb.apply(SPECIES.length());
    ...
    static void maskHashCodeShortVectorMaxTestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "maskProvider")
    static void maskTrueCountShortVectorMaxTestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        ...
        assertMaskReductionArraysEquals(r, a, ShortVectorMaxTests::maskTrueCount);
    }
    ...
    @Test(dataProvider = "maskProvider")
    static void maskLastTrueShortVectorMaxTestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        int[] r = new int[a.length];
        ...
        assertMaskReductionArraysEquals(r, a, ShortVectorMaxTests::maskLastTrue);
    }
    ...
    @Test(dataProvider = "maskProvider")
    static void maskFirstTrueShortVectorMaxTestsSmokeTest(IntFunction<boolean[]> fa) {
        boolean[] a = fa.apply(SPECIES.length());
        int[] r = new int[a.length];
        ...
        assertMaskReductionArraysEquals(r, a, ShortVectorMaxTests::maskFirstTrue);
    }

    @Test(dataProvider = "maskProvider")
    static void maskCompressShortVectorMaxTestsSmokeTest(IntFunction<boolean[]> fa) {
        int trueCount = 0;
        boolean[] a = fa.apply(SPECIES.length());
    ...
    static void indexInRangeShortVectorMaxTestsSmokeTest(int offset) {
    ...
    @Test(dataProvider = "offsetProvider")
    static void indexInRangeLongShortVectorMaxTestsSmokeTest(int offset) {
    ...
    static void loopBoundShortVectorMaxTestsSmokeTest(int length) {
    ...
    @Test(dataProvider = "lengthProvider")
    static void loopBoundLongShortVectorMaxTestsSmokeTest(int _length) {
        long length = _length;
    ...
    @Test
    static void ElementSizeShortVectorMaxTestsSmokeTest() {
    ...
    @Test
    static void VectorShapeShortVectorMaxTestsSmokeTest() {
        ShortVector av = ShortVector.zero(SPECIES);
    ...
    @Test
    static void ShapeWithLanesShortVectorMaxTestsSmokeTest() {
        ShortVector av = ShortVector.zero(SPECIES);
        VectorShape vsh = av.shape();
    ...
    @Test
    static void SpeciesElementSizeShortVectorMaxTestsSmokeTest() {
        ShortVector av = ShortVector.zero(SPECIES);
        assert(av.species().elementSize() == Short.SIZE);
    }

    @Test
    static void VectorTypeShortVectorMaxTestsSmokeTest() {
        ShortVector av = ShortVector.zero(SPECIES);
        assert(av.species().vectorType() == av.getClass());
    }

    @Test
    static void WithLanesShortVectorMaxTestsSmokeTest() {
        ShortVector av = ShortVector.zero(SPECIES);
    ...
    @Test
    static void WithShapeShortVectorMaxTestsSmokeTest() {
        ShortVector av = ShortVector.zero(SPECIES);
        VectorShape vsh = av.shape();
